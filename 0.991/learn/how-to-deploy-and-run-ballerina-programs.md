...
permalink: /0.991/learn/how-to-deploy-and-run-ballerina-programs/
...
1. A [`public function`](/0.991/learn/by-example/functions-as-entry-points.html) including [`main()`](/0.991/learn/by-example/hello-world.html) function that runs as a terminating process.

2. A [`service<>`](/0.991/learn/by-example/hello-world-service.html), which is a hosted non-terminating process.
...
Full example can be found at [Database Interaction Guide](https://ballerina.io/0.991/learn/by-guide/data-backed-service/)
...
Ballerina can be augmented with your own annotations that represent your own unique deployment artifacts. You can also write builder extensions that generate these files during compilation. For more information on how to extend Ballerina, see [How to Extend Ballerina](/0.991/learn/how-to-extend-ballerina/).
