...
permalink: /0.991/learn/how-to-write-secure-ballerina-code/
...
Ballerina provides an API to access configuration values from different sources. For more information, see [Config Ballerina by Example](https://ballerina.io/0.991/learn/by-example/config-api.html).
