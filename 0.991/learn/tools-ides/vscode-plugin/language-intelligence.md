...
permalink: /0.991/learn/vscode-plugin/language-intelligence
redirect_from:
  - /0.991/learn/tools-ides/vscode-plugin/language-intelligence
  - /0.991/learn/tools-ides/vscode-plugin/language-intelligence/
---
...
![Semantic and syntactic diagnostics](/0.991/learn/images/semantic-and-syntactic.gif)
...
![Suggestions and auto completion](/0.991/learn/images/suggestions.gif)
...
![Go to definition](/0.991/learn/images/go-to-definition-vscode.gif)
...
![Find all references](/0.991/learn/images/find-all-references.gif)
...
For example, you can add documentation for a function as shown below.
 ...
 ![Code actions](/0.991/learn/images/code-actions.gif)
...
## Refactoring options
 ...
 ![Refactoring options](/0.991/learn/images/refactoring-options.gif)
...
## Hover support
 ...
 For an example, if you hover over a function name, you can view its description, information about its parameters, and the description of its return type as shown below.
  ...
  ![Hover support](/0.991/learn/images/hover-support.gif)
...
## Signature help support
 ...
 ![Signature help support](/0.991/learn/images/signature-help-support.gif)
...
![Document symbols](/0.991/learn/images/document-symbols.gif)
...
![Workspace symbols](/0.991/learn/images/workspace-symbols.gif)

Above are the lanugage intelligence features that are currently available in the Ballerina VS Code Extension. 

## What's next?

 - For information on the next capability of the VS Code Ballerina extension, see [Run and Debug](/0.991/learn/vscode-plugin/run-and-debug).
 - For information on the VS Code Ballerina extension, see [The Visual Studio Code Ballerina Extension](/0.991/learn/vscode-plugin).
