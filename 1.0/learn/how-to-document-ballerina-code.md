...
permalink: /1.0/learn/how-to-document-ballerina-code/
redirect_from:
  - /v1-0/learn/how-to-document-ballerina-code/
  - /v1-0/learn/how-to-document-ballerina-code
---
...
Check [HTTP module documentation](/v1-0/learn/api-docs/ballerina/http/index.html) for sample HTML that has `Module.md` content at the top, followed by the other module constructs.
