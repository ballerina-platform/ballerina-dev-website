...
* For Map literals, follow the same formatting guidelines as [record literals](/1.0/learn/style-guide/expressions#record-literal). 
...
* Follow [record literals](/1.0/learn/style-guide/expressions#record-literal) formatting when formatting a table block.
