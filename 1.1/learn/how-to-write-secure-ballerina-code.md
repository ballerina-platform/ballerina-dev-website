...
permalink: /1.1/learn/how-to-write-secure-ballerina-code/
redirect_from:
...
Ballerina provides an API to access configuration values from different sources. For more information, see [Config Ballerina by Example](https://ballerina.io/1.1/learn/by-example/config-api.html).
