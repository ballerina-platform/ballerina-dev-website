...
title: Quick Tour
permalink: /1.1/learn/quick-tour/
redirect_from:
  - /v1-1/learn/quick-tour/
  - /v1-1/learn/quick-tour
...
1. Follow the instructions given on the [Getting Started](/1.1/learn/getting-started) page to set it up. 
1. Follow the instructions given on the [Visual Studio Code Plugin](/1.1/learn/tools-ides/vscode-plugin) page or the [IntelliJ IDEA Plugin](/1.1/learn/tools-ides/intellij-plugin) page to set up your preferred editor for Ballerina.
...
* Go through [Ballerina by Examples](/1.1/learn/by-example) to learn Ballerina incrementally with commented examples that cover every nuance of the syntax.
