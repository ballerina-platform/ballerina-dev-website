...
active: definitions
permalink: /1.2/learn/coding-conventions/top-level-definitions/
...
* When formatting resource functions and function definitions, block indent each element and follow the [function formatting guidelines](/1.2/learn/coding-conventions/top-level-definitions/#function-definition).
...
* For function definitions in the object definition, follow the [function formatting guidelines](/1.2/learn/coding-conventions/top-level-definitions/#function-definition).
