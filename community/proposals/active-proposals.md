...
|Proposal|Author|Comments|Created date|Status| 
|---|----|----|----|---| 
|[Proposal: Create databases and tables using `bal persist db push` command](https://github.com/ballerina-platform/ballerina-standard-library/issues/3310)|[MadhukaHarith92](https://github.com/MadhukaHarith92)|0|2022-09-05|Active|
