...
|Proposal|Author|Comments|Created date|Status| 
|---|----|----|----|---| 
|[Proposal: Generate Ballerina client code using `bal persist generate` command](https://github.com/ballerina-platform/ballerina-standard-library/issues/3236)|[MadhukaHarith92](https://github.com/MadhukaHarith92)|1|2022-08-09|Active|
