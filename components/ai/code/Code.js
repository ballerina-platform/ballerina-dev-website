...
export default function UseCases(props) {
    ...
    const npVscodeFeatures = samples['natural-programming-vscode-features'];
            ...
            <Row className="pageContentRow integration code odd">
                <Col xs={12}>
                    <Container>
                        <Row>
                            <Col xs={12} className={styles.box}>
                                <h2 id='natural-programming-vscode-features' className='section'>
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="30"
                                        height="30"
                                        ...
                                        className="bi bi-link-45deg mdButton pe-2"
                                        viewBox="0 0 16 16"
                                        onClick={(e) => props.getLink(e.target, 'natural-programming-vscode-features')}
                                    >
                                        <path d="M4.715 6.542 3.343 7.914a3 3 0 1 0 4.243 4.243l1.828-1.829A3 3 0 0 0 8.586 5.5L8 6.086a1.002 1.002 0 0 0-.154.199 2 2 0 0 1 .861 3.337L6.88 11.45a2 2 0 1 1-2.83-2.83l.793-.792a4.018 4.018 0 0 1-.128-1.287z" />
                                        <path d="M6.586 4.672A3 3 0 0 0 7.414 9.5l.775-.776a2 2 0 0 1-.896-3.346L9.12 3.55a2 2 0 1 1 2.83 2.83l-.793.792c.112.42.155.855.128 1.287l1.372-1.372a3 3 0 1 0-4.243-4.243L6.586 4.672z" />
                                    </svg>
                        ...
                        <Row>
                            ...
                            <Col xs={12} md={7} lg={7} className={styles.box}>
                                <div id="code-tab">
                                    <Tabs defaultActiveKey="npVsCodeFeaturesView1" id="code" className="mb-3 codeTabs">
                                        <Tab eventKey="npVsCodeFeaturesView1" title="Generate code from requirements">
                                            <div className={styles.codeSnippet}>
                                                <img src={`${prefix}/images/np_code_generation_from_requirements.png.png`}/>
                                            </div>
                                        </Tab>
                                        <Tab eventKey="npVsCodeFeaturesView2" title="Check drift between code and documentation">
                                        <div className={styles.codeSnippet}>
                                                <img src={`${prefix}/images/np_drift_check.png`}/>
                                            </div>
                                        </Tab>
                                        <Tab eventKey="npVsCodeFeaturesView3" title="Generate test from requirements">
                                        <div className={styles.codeSnippet}>
                                                <img src={`${prefix}/images/np_test_generation_from_requirements.png.png`}/>
                                            </div>
                                        </Tab>
                                    </Tabs>
                                </div>
            ...
            <Row className="pageContentRow integration code">
                <Col xs={12}>
                    <Container>
                        <Row>
                            <Col xs={12} className={styles.box}>
                                <h2 id='trivial-hosting-in-wso2-choreo' className='section'>
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="30"
                                        height="30"
                                        ...
                                        className="bi bi-link-45deg mdButton pe-2"
                                        viewBox="0 0 16 16"
                                        onClick={(e) => props.getLink(e.target, 'trivial-hosting-in-wso2-choreo')}
                                    >
                                        <path d="M4.715 6.542 3.343 7.914a3 3 0 1 0 4.243 4.243l1.828-1.829A3 3 0 0 0 8.586 5.5L8 6.086a1.002 1.002 0 0 0-.154.199 2 2 0 0 1 .861 3.337L6.88 11.45a2 2 0 1 1-2.83-2.83l.793-.792a4.018 4.018 0 0 1-.128-1.287z" />
                                        <path d="M6.586 4.672A3 3 0 0 0 7.414 9.5l.775-.776a2 2 0 0 1-.896-3.346L9.12 3.55a2 2 0 1 1 2.83 2.83l-.793.792c.112.42.155.855.128 1.287l1.372-1.372a3 3 0 1 0-4.243-4.243L6.586 4.672z" />
                                    </svg>
                                        ...
                                        (ipaas.frontmatter.url && ipaas.frontmatter.url !== '') ?
                                            <div className={styles.dVersion}>
                                                <a href={ipaas.frontmatter.url} className={styles.cDownload} target="_blank" rel="noreferrer">
                                                    Get started with WSO2 Devant for free
                                                </a>
                                            </div>
                                            : null
                                    }
