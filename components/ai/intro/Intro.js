                ...
                <Col xs={12} lg={5} className={styles.introText}>
                    <div>
                        ...
                        <p className={styles.introText2}>
                            AI is no longer only about training models but rather invoking APIs with AI available as a Service from OpenAI, Microsoft, Google, Facebook, and others and composing results.
                        </p>
