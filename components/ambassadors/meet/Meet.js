...
import Ambassadors from '../../../_data/ambassadors.json';

import styles from './Meet.module.css';

export default function Meet(props) {

  const ambassadors = Ambassadors.ambassadors;
  ...
  return (
    <Col xs={12}>
      <Container>
        <Row>
          <Col xs={12}>
            <h2 id='meet-our-ambassadors' className='section'>
              <svg
                ...
                viewBox="0 0 16 16"
                onClick={(e) => props.getLink(e.target, 'meet-our-ambassadors')}
              >
                ...
                <Col xl={{ span: 4 }} className='mb-3' key={index}>
                  <Card className={`h-100 ${styles.customCard}`}>
                    ...
                    <Card.Body>
                      ...
                      <Card.Text>{ambassador.country}</Card.Text>
                    </Card.Body>
                  </Card>
                </Col>
              );
