                ...
                <ul className={styles.customUL}>
                  ...
                  <li className={styles.customLi}><h5>Important Details:</h5>
                    <ul>
                      ...
                      <li><b>Contributor Recognition:</b> A limited number of swag items are available. Contributors will be recognized and rewarded based on the impact and quality of their contributions.</li>
