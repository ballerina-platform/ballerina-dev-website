              ...
              <Card.Body className="d-flex flex-column">
                ...
                <Card.Text>
                  <ul className={styles.customUL}>
                    ...
                    <li className={styles.customLi}><b>Submit the form:</b> After your PR is merged, fill out the <a target='_blank' rel='noreferrer' className={styles.titleLink} href="https://forms.gle/rs5kBkk25ikhgHBg6">form</a> with the PR details and other relevant information.</li>
              ...
              <Card.Body className="d-flex flex-column">
                ...
                <Card.Text>
                  <ul className={styles.customUL}>
                    ...
                    <li className={styles.customLi}><b>Share your work:</b> Publish your content and submit the URLs via the <a target='_blank' rel='noreferrer' className={styles.titleLink} href="https://forms.gle/rs5kBkk25ikhgHBg6">form</a>.</li> 
                  </ul>
                </Card.Text>
              </Card.Body>
            </Card>
