    ...
    <Col sm={12}>
      <Container>
        ...
        <Row className={styles.introBottomRow}>
          ...
          <p className={styles.desItem}><span>We're thrilled to have you on board for Hacktoberfest, and we've got some fantastic opportunities lined up for you. See the many ways you can support the open source community and contribute to Ballerina.</span></p>
          </Col>
