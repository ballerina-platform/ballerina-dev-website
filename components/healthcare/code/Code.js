                    ...
                    <Container>
                        <Row>
                            <Col xs={12} className={styles.box}>
                                <h2 id='what-makes-ballerina-the-ideal-choice-for-developing-healthcare-applications' className='section'>
                                    <svg
                                        ...
                                        viewBox="0 0 16 16"
                                        onClick={(e) => props.getLink(e.target, 'what-makes-ballerina-the-ideal-choice-for-developing-healthcare-applications')}
                                    >
