...
description: Ballerina has powerful support for Electronic Data Interchange (EDI) formats. In healthcare, this means out-of-the-box handling of X12, 834s, 837s, and more regional-specific standards via native schema mapping. Go from EDI formats to Ballerina Records and back; Do Data Mapping on that, and you’re off to the races!
