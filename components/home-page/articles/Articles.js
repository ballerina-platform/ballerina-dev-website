                    ...
                    <Col sm={12} md={12} lg={4} styles={styles.newsCard}>
                      <Card className={styles.cardBox}>
                        <Card.Body className={styles.cardBody}>
                          {/* <Card.Title className={styles.cardTitle}>Blog posts</Card.Title> */}
                          <Card.Text className={styles.cardText}>
                            <a target="_blank" rel="noreferrer" href="https://www.simform.com/blog/microservices-framework/">
                              <h4 className="card-title" >The Top Go-To Microservices Frameworks for a Scalable Application</h4>
                            </a>
                          </Card.Text>
                          <div>
                            <p className={styles.author}> By <span>Hiren Dhaduk</span> in SIMFORM</p>
                            <p className={styles.date}>March 15, 2022</p>
                          </div>
                        </Card.Body>
                      </Card>
                    </Col>
