      ...
      <Container>
        ...
        <Row>
          <Col sm={18} md={12} className={styles.logo}>
              ...
              <a href={`${prefix}/case-studies/redcross-elixir`} target='_blank'><img src={`${prefix}/images/home-page/user-logos/redcross-elixir.png`} width={280} alt="Redcross Elixir" title="Redcross Elixir" /></a>
