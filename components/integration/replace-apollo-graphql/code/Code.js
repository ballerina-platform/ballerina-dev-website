...
export default function UseCases(props) {
    ...
    React.useEffect(() => {
        (function () {
            var container = document.getElementById("code-container-1"),
                left = document.getElementById("left-panel-1"),
                right = document.getElementById("right-panel-1"),
                handle = document.getElementById("drag-1");
