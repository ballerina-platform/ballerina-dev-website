                        ...
                        <Col xs={12} md={4} lg={4} className={styles.useCaseCard}>
                            ...
                            <div>
                                ...
                                <div className={styles.cardDescription}>
                                    ...
                                    <p>Use Ballerina&apos;s extended Ballerina library to connect to any system, speak any protocol, process any data, and run it anywhere (on a VM, in Kubernetes, or just as a script).</p>
