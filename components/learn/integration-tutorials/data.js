export const data = [
    {
      ...
      tags: 
        ["HTTP Client", "HTTP Service", "REST API", "Data Binding", "Integration"]
      ,
      icon: false
    },

    {
      ...
      tags: 
      ["Content-based Routing", "HTTP Client", "HTTP Service", "REST API", "Data Binding", "Integration"]
      ,
      icon: false
    },

    {
      ...
      tags: 
      ["Service Orchestration", "HTTP Client", "HTTP Service", "REST API", "Data Binding", "Integration"]
      ,
      icon: false
    },

    {
      ...
      tags: 
      ["Data Mapper", "Data Transformation", "HTTP Client", "HTTP Service", "REST API", "Data Binding", "Integration"]
      ,
      icon: false
    },
