...
description: "Ballerina's AI capabilities can be used to streamline the updating of Salesforce by extracting valuable sales-related information from ad-hoc sources like emails, Word documents, and slides. <br/><br/><i>Example: Extract lead details such as name, phone number and company from emails using OpenAI, and create corresponding leads in Salesforce.</i>"
