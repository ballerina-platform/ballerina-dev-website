              ...
              <Row className="g-0 align-items-center">
                ...
                <Col md={10}>
                  <Card.Body>
                    ...
                    <p className="card-text">Connect students with industry experts for innovative solutions through guided project development. <a href={`/project-mentorship`} className={styles.cardLinks}>See more</a></p>
