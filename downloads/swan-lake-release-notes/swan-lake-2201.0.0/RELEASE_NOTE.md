...
If you are already using Ballerina, use the [Ballerina update tool](/learn/bal-command/update-tool/#using-the-update-tool) to directly update to 2201.0.0 (Swan Lake). To do this: 
