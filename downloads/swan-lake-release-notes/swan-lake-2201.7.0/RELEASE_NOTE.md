...
- Added new API named workspaceProjects to workspace manager to get the projects loaded in the workspace.
- Added completion items for ballerinax modules queried from central in import statement context.
...
- Improved the order of completion items in client resource access action context.
- Improved the documentation generated by the document this code action to follow Ballerina code-style best practices.
- Improved the placeholder support provided for service-template snippet completion items. 
