...
It introduces the new language features planned for the Swan Lake GA release and includes improvements and bug fixes done to the compiler, runtime, Ballerina library, and developer tooling after the Swan Lake Alpha5 release.

## Updating Ballerina

If you are already using Ballerina, use the [Ballerina update tool](/learn/update-tool/) to directly update to Ballerina Swan Lake Beta1. 
