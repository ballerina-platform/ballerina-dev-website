...
It introduces the new language features planned for the Swan Lake GA release and includes improvements and bug fixes done to the compiler, runtime, Ballerina library, and developer tooling after the Swan Lake Beta1 release.
