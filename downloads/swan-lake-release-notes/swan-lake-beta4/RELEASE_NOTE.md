...
If you are already using Ballerina, you can use the [update tool](/learn/bal-command/update-tool/) to directly update to Ballerina Swan Lake Beta4 as follows. 
