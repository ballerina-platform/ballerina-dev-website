var searchData = {
  ...
  "classes": [
    ...
    {
      "id": "Headers",
      "description": "Represents the headers of the inbound request.",
      "moduleId": "http",
      "moduleOrgName": "ballerina",
      "moduleVersion": "1.1.0-alpha3"
    },
  ...
  "functions": [
    ...
    {
      "id": "decodeRsaPrivateKeyFromKeyFile",
      "description": "Reads a private key from the provided private key and private key password.",
      "moduleId": "crypto",
      "moduleOrgName": "ballerina",
      "moduleVersion": "1.1.0-alpha3"
    },
    {
      "id": "decodeRsaPrivateKeyFromKeyStore",
    ...
    {
      "id": "decodeRsaPublicKeyFromCertFile",
      "description": "Reads a public key from the provided public certificate file.",
      "moduleId": "crypto",
      "moduleOrgName": "ballerina",
      "moduleVersion": "1.1.0-alpha3"
    },
    {
      "id": "decodeRsaPublicKeyFromTrustStore",
    ...
    {
      "id": "decryptString",
      "description": "Returns an decrypted string value for given encrypted config string.",
      "moduleId": "lang.config",
      "moduleOrgName": "ballerina",
      "moduleVersion": "0.0.1"
    },
    {
    ...
    {
      "id": "createTime",
      "description": "Returns the Time record correspoding to the given time components and time-zone.",
      "moduleId": "time",
      "moduleOrgName": "ballerina",
      "moduleVersion": "1.1.0-alpha3"
    },
  ...
  "records": [
    ...
    {
      "id": "Data",
      "description": "Represents the data in an output object for a GraphQL query.",
      "moduleId": "graphql",
      "moduleOrgName": "ballerina",
      "moduleVersion": "0.2.0-alpha3"
    },
    ...
    {
      "id": "GraphqlServiceConfiguration",
      "description": "Provides a set of configurations for the GraphQL service.",
      "moduleId": "graphql",
      "moduleOrgName": "ballerina",
      "moduleVersion": "0.2.0-alpha3"
    },
    ...
    },
    {
      ...
      "description": "A record for providing configurations for validate the certificate chain from the root CA.",
      "moduleId": "graphql",
      "moduleOrgName": "ballerina",
      "moduleVersion": "0.2.0-alpha3"
    },
    {
      ...
      "description": "Configures the SSL/TLS options to be used for the underlying HTTP service used in GraphQL service.",
      "moduleId": "graphql",
      "moduleOrgName": "ballerina",
      "moduleVersion": "0.2.0-alpha3"
    },
    ...
    {
      "id": "Protocols",
      "description": "A record for configuring SSL/TLS protocol and version to be used for the undelying HTTP service.",
      "moduleId": "graphql",
      "moduleOrgName": "ballerina",
      "moduleVersion": "0.2.0-alpha3"
    },
    ...
    {
      "id": "HttpHeader",
      "description": "Defines the Header resource signature parameter.",
      "moduleId": "http",
      "moduleOrgName": "ballerina",
      "moduleVersion": "1.1.0-alpha3"
    },
    ...
    {
      "id": "XmlWriteOptions",
      "description": "The writing options of an XML.",
      "moduleId": "io",
      "moduleOrgName": "ballerina",
      "moduleVersion": "0.6.0-alpha3"
    },
    ...
    {
      "id": "IssuerSignatureConfig",
      "description": "Represents JWT signature configurations.",
      "moduleId": "jwt",
      "moduleOrgName": "ballerina",
      "moduleVersion": "1.1.0-alpha3"
    },
  ...
  "errors": [
    ...
    },
    {
      ...
      "description": "Represents an error due to invalid configurations\n",
      "moduleId": "graphql",
      "moduleOrgName": "ballerina",
      "moduleVersion": "0.2.0-alpha3"
    },
    ...
    {
      "id": "ServiceHandlingError",
      "description": "Represents an error occurred in the listener while handling a service\n",
      "moduleId": "graphql",
      "moduleOrgName": "ballerina",
      "moduleVersion": "0.2.0-alpha3"
    },
  ...
  "annotations": [
    ...
    {
      "id": "ServiceConfiguration",
      "description": "The annotation to configure a GraphQL service.",
      "moduleId": "graphql",
      "moduleOrgName": "ballerina",
      "moduleVersion": "0.2.0-alpha3"
    },
    ...
    {
      "id": "Header",
      "description": "The annotation which is used to define the Header resource signature parameter.",
      "moduleId": "http",
      "moduleOrgName": "ballerina",
      "moduleVersion": "1.1.0-alpha3"
    },
  ...
  "enums": [
    ...
    {
      "id": "XmlEntityType",
      "description": "Represents the XML entity type that needs to be written.",
      "moduleId": "io",
      "moduleOrgName": "ballerina",
      "moduleVersion": "0.6.0-alpha3"
    },
