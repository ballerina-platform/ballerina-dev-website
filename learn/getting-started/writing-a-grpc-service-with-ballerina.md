...
The service code for the service definition can be generated by executing the following command inside the same directory where you created the Ballerina project.
...
The source code related to the service definition can be generated by executing the following command inside the same directory where you created the Ballerina project.
