...
The values can be configured through the configuration files in the [TOML(v0.4) format](https://toml.io/en/v0.4.0). 
...
content is expected to be in the [TOML(v0.4) format](https://toml.io/en/v0.4.0).
>**Note:** Configuring individual values through separate environment variables is not supported.
