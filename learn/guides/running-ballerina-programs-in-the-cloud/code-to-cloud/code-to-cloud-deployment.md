...
Before invoking the container, let’s observe the dockerfile below that has been generated. This is a dockerfile created by the compiler extension from your code to run your http service in docker environment easily.
...
Once you build the ballerina package and the compiler extension will generate the artifacts required for k8s deployment.
