...
>**Tip:** If you are using Minikube, execute the `eval $(minikube docker-env)` before building the image if you don't want to push the container to the docker registry.
