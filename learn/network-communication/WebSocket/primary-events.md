...
title: Using Primary Events
description: The below are the primary events in WebSocket services. 
keywords: ballerina, cli, command line interface, programming language
permalink: /learn/network-communication/websocket/using-primary-events/
active: using-primary-events
intro: The below are the primary events in WebSocket services.  
redirect_from:
  - /learn/network-communication/websocket/using-primary-events
  - /swan-lake/learn/network-communication/websocket/using-primary-events/
  - /swan-lake/learn/network-communication/websocket/using-primary-events
---
