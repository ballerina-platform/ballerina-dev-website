...
* Go through the [Ballerina by Examples](/learn/by-example) to learn Ballerina incrementally with the commented examples that cover every nuance of the syntax.
