...
const nextConfig = {
  ...
  async rewrites() {
    return [
      ...
      {
        source: `/learn/work-with-llms-using-natural-expressions`,
      ...
      {
        source: `/learn/language-guarantees`,
        destination: `/learn/development-tutorials/static-code-analysis/language-guarantees`,
      },
      {
