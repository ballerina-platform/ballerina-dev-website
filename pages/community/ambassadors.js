    ...
    <>
      <Head>
        ...
        <meta
          property="og:image"
          itemProp="image"
          content="https://ballerina.io/images/ambassadors/ballerina-student-program-sm-banner.png"
        />
              ...
              <Container>
                <Row>
                  ...
                  <Col xs={12} md={12} lg={6} className='introImg'>
                    <img src="/images/ambassadors/ballerina-student-program-image.png" alt="Project mentorship" />
                  </Col>
                </Row>
              </Container>
            </Col>
