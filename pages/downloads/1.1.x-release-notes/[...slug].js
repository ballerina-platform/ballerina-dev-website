...
export async function getStaticProps({ params: { slug } }) {
  ...
  const fileName = fs.readFileSync(`downloads/1.1.x-release-notes/${slug}/RELEASE_NOTE.html`, 'utf-8');
          ...
          <Container>
            <div className='topRow'>
              ...
              <Col xs={1} className="gitIcon">
                <a href={`${process.env.gitHubPath}downloads/1.1.x-release-notes/${id}/RELEASE_NOTE.html`}>
