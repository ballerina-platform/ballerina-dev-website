...
export async function getStaticProps() {
  const fileName = fs.readFileSync(`swan-lake/vs-code-extension/build-executables.md`, "utf-8");
  const { data: frontmatter, content } = matter(fileName);
  const id = "build-executables";
          ...
          <Container>
            <div className="topRow">
              ...
              <Col xs={1} className="gitIcon">
                <a
                  href={`${process.env.gitHubPath}swan-lake/vs-code-extension/build-executables.md`}
                  target="_blank"
                  rel="noreferrer"
