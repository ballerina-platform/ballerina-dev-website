...
export async function getStaticProps() {
  const fileName = fs.readFileSync(`swan-lake/vs-code-extension/configure-the-extension.md`, "utf-8");
  const { data: frontmatter, content } = matter(fileName);
  const id = "configure-the-extension";
      ...
      <Layout>
        <Col sm={3} xxl={2} className="leftNav d-none d-sm-block">
          ...
          <LeftNav
            launcher="learn"
            id={id}
            mainDir="configure-the-extension"
            Toc={LearnToc}
          />
        </Col>
          ...
          <Container>
            <div className="topRow">
              ...
              <Col xs={1} className="gitIcon">
                <a
                  href={`${process.env.gitHubPath}swan-lake/vs-code-extension/configure-the-extension.md`}
                  target="_blank"
                  rel="noreferrer"
