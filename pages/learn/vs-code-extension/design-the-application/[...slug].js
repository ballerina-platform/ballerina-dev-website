...
var traverseFolder = function (dir) {
  ...
  list.forEach(function (file) {
    ...
    if (stat && stat.isDirectory()) {
      ...
      /* Is a file */
      filex = filex.replace(/swan-lake\/vs-code-extension\/design-the-application\//g, "");
      results.push(filex);
    }
  });
  return results;
...
export async function getStaticPaths() {
  ...
  const files = traverseFolder("swan-lake/vs-code-extension/design-the-application");
...
export async function getStaticProps({ params: { slug } }) {
  ...
  const fileName = fs.readFileSync(
    `swan-lake/vs-code-extension/design-the-application/${slug}.md`,
    "utf-8"
  );
      ...
      <Layout>
        <Col sm={3} xxl={2} className="leftNav d-none d-sm-block">
          ...
          <LeftNav
            launcher="vs-code"
            id={id}
            mainDir="design-the-application"
            sub={sub}
            third={third}
            Toc={LearnToc}
          />
          ...
          <Container>
            <div className="topRow">
              ...
              <Col xs={1} className="gitIcon">
                <a
                  href={`${process.env.gitHubPath}swan-lake/vs-code-extension/design-the-application/${slug}.md`}
                  target="_blank"
                  rel="noreferrer"
