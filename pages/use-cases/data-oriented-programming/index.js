...
import Intro from "../../../components/data-oriented-programming/intro/Intro";
import Code from "../../../components/data-oriented-programming/code/Code";
...
export async function getStaticProps() {
  ...
  files.forEach(function (item, index) {
    ...
    const sampleName = item.replace('components/data-oriented-programming/code/java-bbe/', '').replace('.md', '');
  ...
  return (
    <>
      <Head>
        ...
        <title>Data-oriented programming with Ballerina - The Ballerina programming language</title>
      ...
      <Layout>
        <Col sm={12}>
          <Row className="pageHeader pageContentRow integration">
            <Col xs={12}>
              <Container>
                <h1>Data-oriented programming with Ballerina</h1>
              </Container>
