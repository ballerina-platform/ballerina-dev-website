...
import Intro from "../../../components/eda/intro/Intro";
import Code from "../../../components/eda/code/Code";
...
export async function getStaticProps() {
  ...
  const files = traverseFolder("components/eda/code/eda-bbe");
  var samples = {};

  files.forEach(function (item, index) {
    const filename = fs.readFileSync(item, "utf-8");
    const sampleName = item.replace('components/eda/code/eda-bbe/', '').replace('.md', '');
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Write code with EDA-friendly abstractions."
        />
        ...
        <title>Ballerina for EDA - The Ballerina programming language</title>
        ...
        <meta name="twitter:title" content="Ballerina for EDA - The Ballerina programming language" />
