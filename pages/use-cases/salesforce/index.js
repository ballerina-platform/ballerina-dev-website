...
import Intro from "../../../components/salesforce/intro/Intro";
import Code from "../../../components/salesforce/code/Code";
...
export async function getStaticProps() {
  ...
  const files = traverseFolder("components/salesforce/code/salesforce-bbe");
  var samples = {};

  files.forEach(function (item, index) {
    const filename = fs.readFileSync(item, "utf-8");
    const sampleName = item.replace('components/salesforce/code/salesforce-bbe/', '').replace('.md', '');
    ...
    <>
      <Head>
        ...
        <meta
          property="og:image"
          itemProp="image"
          content="https://ballerina.io/images/ballerina-use-cases-ballerina-for-salesforce-sm-banner.png"
        />
      ...
      <Layout>
        <Col sm={12}>
          <Row className="pageHeader pageContentRow integration">
            <Col xs={12}>
              <Container>
                <h1>Ballerina for Salesforce</h1>
              </Container>
