...
import Intro from "../../../components/etl/intro/Intro";
import UseCases from "../../../components/etl/use-cases/UseCases";
import Code from "../../../components/etl/code/Code";
...
export async function getStaticProps() {
  ...
  const files = traverseFolder("components/etl/code/etl-bbe");
  var samples = {};

  files.forEach(function (item, index) {
    const filename = fs.readFileSync(item, "utf-8");
    const sampleName = item.replace('components/etl/code/etl-bbe/', '').replace('.md', '');
  ...
  return (
    <>
      <Head>
        ...
        <title>Ballerina for ETL</title>

        {/* FB */}
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Ballerina - Ballerina for ETL" />
        <meta
        ...
        <meta
          property="og:image"
          itemProp="image"
          content="https://ballerina.io/images/ballerina-etl-sm-banner.png"
        />
        ...
        <meta name="twitter:title" content="Ballerina - Ballerina for ETL" />
