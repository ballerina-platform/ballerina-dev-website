...
import Intro from "../../../../components/integration/replace-boomi/intro/Intro";
import UseCases from "../../../../components/integration/replace-boomi/use-cases/UseCases";
import Code from "../../../../components/integration/replace-boomi/code/Code";
...
export async function getStaticProps() {
  ...
  const files = traverseFolder("components/integration/replace-boomi/code/boomi-bbe");
  var samples = {};

  files.forEach(function (item, index) {
    const filename = fs.readFileSync(item, "utf-8");
    const sampleName = item.replace('components/integration/replace-boomi/code/boomi-bbe/', '').replace('.md', '');
