...
import Intro from "../../../../components/integration/replace-camel/intro/Intro";
import UseCases from "../../../../components/integration/replace-camel/use-cases/UseCases";
import Code from "../../../../components/integration/replace-camel/code/Code";
...
export async function getStaticProps() {
  ...
  const files = traverseFolder("components/integration/replace-camel/code/camel-bbe");
  var samples = {};

  files.forEach(function (item, index) {
    const filename = fs.readFileSync(item, "utf-8");
    const sampleName = item.replace('components/integration/replace-camel/code/camel-bbe/', '').replace('.md', '');
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="Next-Generation Integration: Elevating Integration to New Heights Beyond Apache Camel" />
        <meta
