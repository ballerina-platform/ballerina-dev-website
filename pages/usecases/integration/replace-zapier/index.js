...
import Intro from "../../../../components/integration/replace-zapier/intro/Intro";
import UseCases from "../../../../components/integration/replace-zapier/use-cases/UseCases";
import Code from "../../../../components/integration/replace-zapier/code/Code";
...
export async function getStaticProps() {
  ...
  const files = traverseFolder("components/integration/replace-zapier/code/zapier-bbe");
  var samples = {};

  files.forEach(function (item, index) {
    const filename = fs.readFileSync(item, "utf-8");
    const sampleName = item.replace('components/integration/replace-zapier/code/zapier-bbe/', '').replace('.md', '');
  ...
  return (
    <>
      <Head>
        ...
        <title>Simplify your automation with Ballerina - The smarter choice over Zapier</title>

        {/* FB */}
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Simplify your automation with Ballerina - The smarter choice over Zapier" />
        <meta
      ...
      <Layout>
        <Col sm={12}>
          <Row className="pageHeader pageContentRow integration">
            <Col xs={12}>
              <Container>
                <h1>Simplify your automation with Ballerina - The smarter choice over Zapier</h1>
              </Container>
