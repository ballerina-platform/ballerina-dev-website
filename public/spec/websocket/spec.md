...
This is the specification for the WebSocket Ballerina library of [Ballerina language](https://ballerina.io/), which provides WebSocket client-server functionalities.
