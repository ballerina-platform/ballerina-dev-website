...
export function AdvancedConflictHandling({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>Advanced conflict handling</h1>

      <p>
        We can implement a custom conflict-handling policy to determine whether
        to replace a value or throw an error in the event of conflicting keys
        when constructing a map or table.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/advanced-conflict-handling",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run advanced_conflict_handling.bal`}</span>
              <span>{`{"John":200,"Jane":150}`}</span>
              <span>{`error("Key Conflict",message="Duplicate key has an odd score")`}</span>
            </code>
          </pre>
        </Col>
      </Row>
