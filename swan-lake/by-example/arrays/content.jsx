...
<p>An array can be used to hold a set of values of the same type. The array type can be defined as <code>T[n]</code> in which <code>T</code> is the element type and <code>n</code> is the length of the array. <code>n</code> must be an integer literal or constant reference of type <code>int</code>. Optionally, you can create a variable-length array by defining an array without <code>n</code> as <code>T[]</code>.</p>


<p>The length of the array can be inferred from the context by defining the array as <code>T[*]</code>. The length of the array should be known in compile time.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/arrays", "_blank");
      }}
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="/learn/by-example/nested-arrays">Nested arrays</a></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} class="relatedLinks">
...
<ul style={{ marginLeft: "0px" 
      ...
      <Link
        title="Nested arrays"
        href="/learn/by-example/nested-arrays"
      >
