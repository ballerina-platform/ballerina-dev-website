...
export function AvroSerdes({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        The <code>avro</code> module allows serializing and deserializing the
        subtypes of Ballerina <code>anydata</code>. Initially, an{" "}
        ...
        <code>avro</code> module serialize and deserialize data respectively,
        using the generated Avro schema.
      </p>

      <p>
        The <code>toAvro()</code> method serializes the given data according to
        the specified Avro schema. The <code>fromAvro()</code> method accepts a{" "}
