        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal new aws_lambda_execution_context`}</span>
              <span>{`Created new package 'aws_lambda_execution_context' at /Users/wso2/aws_lambda_execution_context.`}</span>
            </code>
          </pre>
        </Col>
      </Row>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/aws-lambda-execution-context",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref2}>
            <code className="d-flex flex-column">
              ...
              <span>{`        wso2/aws_lambda_execution_context:0.1.0`}</span>
              <span>{`
`}</span>
