        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal new aws_lambda_s3_trigger`}</span>
              <span>{`Created new package 'aws_lambda_s3_trigger' at /Users/wso2/aws_lambda_s3_trigger.`}</span>
            </code>
          </pre>
        </Col>
      </Row>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/aws-lambda-s3-trigger",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref2}>
            <code className="d-flex flex-column">
              ...
              <span>{`        wso2/aws_lambda_s3_trigger:0.1.0`}</span>
              <span>{`
`}</span>
              <span>{`Generating executable`}</span>
              <span>{`        @awslambda:Function: s3Trigger`}</span>
              <span>{`
`}</span>
...
`}</span>
      ...
      >
        ...
        <Col sm={12}>
          <pre ref={ref3}>
            <code className="d-flex flex-column">
              <span>{`\$ aws lambda create-function --function-name s3Trigger --zip-file fileb://aws-ballerina-lambda-functions.zip --handler aws-lambda-s3-trigger.s3Trigger --runtime provided --role arn:aws:iam::908363916111:role/lambda-role--layers arn:aws:lambda:us-west-1:134633749276:layer:ballerina-jre11:6 --memory-size 512 --timeout 10`}</span>
            </code>
          </pre>
        </Col>
      </Row>
      ...
      <blockquote>
        <p>
          <strong>Note:</strong> Make sure to select the same{" "}
          <strong>AWS region</strong> in which you created the AWS user and role
          when creating the S3 bucket.
        </p>
      </blockquote>
      ...
      <ul style={{ marginLeft: "0px" }}>
        <li>
          <span>4.</span>
          <span>
            Under the <strong>Destination</strong> section, select the AWS
            Lambda function (i.e., <code>s3Trigger</code> in this example) from
            the dropdown.
          </span>
        </li>
      </ul>
      <ul style={{ marginLeft: "0px" }}>
        <li>
          <span>5.</span>
          <span>
            Select the created bucket under the <strong>Buckets</strong> list,
            click <strong>Upload</strong>, and upload an object to the S3
            bucket.
          </span>
        </li>
      </ul>
      <ul style={{ marginLeft: "0px" }}>
        <li>
          <span>6.</span>
          <span>
            Under the <strong>Functions</strong> list of the AWS Management
            Console, click the AWS Lambda function, and click the{" "}
            <strong>Monitor</strong> tab.
          </span>
        </li>
      </ul>
      <ul style={{ marginLeft: "0px" }}>
        <li>
          <span>7.</span>
          <span>
            If you get a <strong>Missing permissions</strong> notice at the top,
            click the <strong>Open the IAM Console</strong> in it.
          </span>
        </li>
      </ul>
      <ul style={{ marginLeft: "0px" }}>
      ...
      <ul style={{ marginLeft: "0px" }}>
        <li>
          ...
          <span>
            ...
            add the <strong>AWSLambdaBasicExecutionRole</strong> to the role.
          </span>
        </li>
      </ul>
      <ul style={{ marginLeft: "0px" }}>
