...
export function AzureFunctionsHttpTriggerWithQueue({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>Azure Functions - HTTP trigger with queue</h1>
      ...
      <ul style={{ marginLeft: "0px" }}>
        <li>
          <span>2.</span>
          <span>
            In the AWS Portal, click <strong>Storage accounts</strong> to create
            a queue to hold the outputs of the function.
          </span>
        </li>
      </ul>
      <ul style={{ marginLeft: "0px" }}>
        <li>
          <span>2.</span>
          <span>
            From the list, click on the storage account entry that corresponds
      ...
      <ul style={{ marginLeft: "0px" }}>
        <li>
          <span>3.</span>
          <span>
            Click <strong>Queues</strong> in the sidebar, and click{" "}
            <strong>+ Queue</strong>.
          </span>
        </li>
      </ul>
      <ul style={{ marginLeft: "0px" }}>
        <li>
          <span>4.</span>
          <span>
            Enter a name in the <strong>Add queue</strong> pop-up, and click{" "}
            <strong>Add</strong>.
          </span>
        </li>
      </ul>
      <blockquote>
        <p>
          <strong>Note:</strong> For the <strong>Queue name</strong>, enter the
          same value of the <code>queueName</code> property in the{" "}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal new azure_functions_http_trigger_with_queue`}</span>
              <span>{`Created new package 'azure_functions_http_trigger_with_queue' at /Users/wso2/azure_functions_http_trigger_with_queue.`}</span>
            </code>
          </pre>
        </Col>
      </Row>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/azure-functions-http-trigger-with-queue",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref2}>
            <code className="d-flex flex-column">
              ...
              <span>{`	wso2/azure_functions_http_trigger_with_queue:0.1.0`}</span>
              <span>{`
`}</span>
              <span>{`Generating executable`}</span>
              <span>{`
`}</span>
              <span>{`	@azure.functions:Function: post-queue`}</span>
              <span>{`
`}</span>
...
`}</span>
              ...
              <span>{`
`}</span>
              <span>{`	target/bin/azure_functions_http_trigger_with_queue.jar`}</span>
            </code>
          </pre>
        </Col>
      </Row>
      ...
      <p>
        Execute the command below by replacing{" "}
        <code>&lt;function_app_name&gt;</code> with your respective function app
        name to invoke the function.
      </p>
      ...
      <blockquote>
        <p>
          <strong>Tip:</strong> Refresh the page of the <code>people</code>{" "}
          queue in the Azure portal and view the entry added with the message
          text: <code>Jack is 21 years old.</code>
        </p>
      </blockquote>
