...
export const codeSnippetData = [`import ballerinax/azure_functions as af;
...
<p>Azure Functions is an event driven, serverless computing platform. Azure Functions can be written from Ballerina using the listeners and services provided by Azure Functions package. You can view the code examples below.</p>


<p>For more information, see the <a href="/learn/run-in-the-cloud/function-as-a-service/azure-functions/">Azure deployment guide</a>.</p>
...
<p>Create a Ballerina package and replace the content of the generated BAL file with the content above.</p>
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal new azure-functions-timer-trigger`}</span>
</code></pre>
          </Col>
        </Row>

<p>Build the Ballerina program to generate the Azure Functions artifacts.</p>
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref2}>
      <code className="d-flex flex-column"><span>{`\$ bal build --cloud="azure_functions"`}</span>
<span>{`Compiling source`}</span>
<span>{`        wso2/azure-functions-timer-trigger:0.1.0`}</span>
<span>{`
`}</span>
...
<p>Execute the Azure CLI command given by the compiler to publish the functions (replace the sample app name given in the command with your respective Azure <code>&lt;function_app_name&gt;</code>).</p>
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref3}>
      <code className="d-flex flex-column"><span>{`\$ func azure functionapp publish bal-bbe --script-root target/azure_functions`}</span>
...
<p>Invoke the <code>HTTP Trigger</code> functions.</p>
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref4}>
      <code className="d-flex flex-column"><span>{`\$ curl https://bal-bbe.azurewebsites.net/hello\\?name\\=Jack`}</span>
<span>{`Hello, Jack!`}</span>
</code></pre>
          </Col>
        </Row>

<p>The <code>timer</code> function is triggered by the Azure Functions app from a timer. You can check the queue storage to see the output. For more information on the infrastructure, see <a href="/learn/run-in-the-cloud/function-as-a-service/azure-functions/">Azure Functions deployment</a>.</p>
