...
export function AzureFunctionsTimerTrigger({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        This example demonstrates how a function can be scheduled to execute
        periodically by the Azure Functions app. Once the function is executed,
        the timer details will be stored in the selected queue storage for every
        invocation.
      </p>
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal new azure_functions_timer_trigger`}</span>
              <span>{`Created new package 'azure_functions_timer_trigger' at /Users/wso2/azure_functions_timer_trigger.`}</span>
            </code>
          </pre>
        </Col>
      </Row>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/azure-functions-timer-trigger",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref2}>
            <code className="d-flex flex-column">
              ...
              <span>{`	wso2/azure_functions_timer_trigger:0.1.0`}</span>
              <span>{`
`}</span>
              <span>{`Generating executable`}</span>
              <span>{`
`}</span>
              <span>{`	@azure.functions:Function: timer`}</span>
              <span>{`
`}</span>
...
`}</span>
              ...
              <span>{`
`}</span>
              <span>{`	target/bin/azure_functions_timer_trigger.jar`}</span>
            </code>
          </pre>
        </Col>
      </Row>
      ...
      <p>
        ...
        from a timer. Follow the steps below to verify the output in the queue
        storage of the function app.
      </p>
      ...
      <ul style={{ marginLeft: "0px" }}>
        <li>
          <span>1.</span>
          <span>
            In the AWS Portal, click <strong>Storage accounts</strong> to view
            the created queue.
          </span>
        </li>
      </ul>
      ...
      <ul style={{ marginLeft: "0px" }}>
        <li>
          ...
          <span>
            ...
            , and click on the <strong>queue3</strong> queue.
          </span>
        </li>
      </ul>
      <ul style={{ marginLeft: "0px" }}>
        <li>
          <span>4.</span>
          <span>
            You view the output below getting logged every 10 seconds.
          </span>
        </li>
      </ul>
      <p>
        <code>Hello from timer: &lt;CURRENT_TIME&gt;</code>
      </p>
