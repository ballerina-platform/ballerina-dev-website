...
export default function BindingPatternsInAssignment() {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>Binding patterns in assignment</h1>

      <p>
        The destructuring syntax can be used to bind to variables in
        assignments. This can be used to do some operations efficiently.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=c5cda77eda20404e9c4534428685f1e7&file=binding_patterns_in_assignment.bal",
                "_blank"
              );
            }}
            target="_blank"
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.1/examples/binding-patterns-in-assignment",
                "_blank"
              );
            }}
