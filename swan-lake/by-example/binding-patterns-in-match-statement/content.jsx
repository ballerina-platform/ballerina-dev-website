...
const ref1 = createRef()
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>Binding patterns in the <code>match</code> statement</h1>


<p>Binding patterns can be used in a match statement to bind parts of a successful match to variables.</p>

<p>You can use the rest binding pattern (<code>...r</code>) in a binding pattern of a <code>match</code> statement to bind the fields that are not explicitly bound in the binding pattern. This is particularly useful when working with open records.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/binding-patterns-in-match-statement", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run binding_patterns_in_match_statement.bal`}</span>
<span>{`1, 2`}</span>
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="/learn/by-example/if-statement/">If statement</a></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} class="relatedLinks">
