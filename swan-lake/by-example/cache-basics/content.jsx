...
export const codeSnippetData = [`import ballerina/cache;
import ballerina/io;
...
<p>The <code>cache</code> library provides in-memory cache implementation APIs and uses the <code>Least Recently Used</code> algorithm-based eviction policy.</p>


<p>For more information on the underlying module, see the <a href="https://lib.ballerina.io/ballerina/cache/latest/"><code>cache</code> module</a>.</p>


<p>This example illustrates the basic operations provided by the <code>cache</code> library.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/cache-basics", "_blank");
      }}
