...
export function CastingJsonToUserDefinedType({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        In order to access the field in the <code>json</code> value, the easiest
        way is to convert the <code>json</code> value to a user-defined type.
      </p>

      <p>
        The type-casting can be used to do that. However, if the cast fails, the
        program panics with an error. The recommended way to do this is by using
        langlib functions.
      </p>
      ...
      <p>
        Casting immutable values will work. However, it does not do numeric
        conversions.
      </p>
        ...
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
<<<<<<< HEAD
                "https://play.ballerina.io/?gist=aa5402c941201b628eee962a21b2418e&file=casting_json_to_user_defined_type.bal",
=======
                "https://play.ballerina.io/?gist=40ae6a0ce9f4d94c6d834e4f53c0ae3e&file=casting_json_to_user_defined_type.bal",
>>>>>>> 4544b7b84e3fbafce0347071b7db377f1be8adda
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.7.0/examples/casting-json-to-user-defined-type",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run casting_json_to_user_defined_type.bal`}</span>
              <span>{`1.0`}</span>
              <span>{`2.0`}</span>
            </code>
          </pre>
