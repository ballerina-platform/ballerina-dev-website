    ...
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=cbca6c6295e8efa4b712ae98a56ae2ef&file=casting_json_to_user_defined_type.bal",
                "_blank"
              );
            }}
            target="_blank"
      ...
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
        <li>
          <span>&#8226;&nbsp;</span>
          <span>
            <a href="/learn/by-example/converting-json-with-langlib-functions/">
      ...
      <Row className="mt-auto mb-5">
        <Col sm={6}>
          <Link
            title="Converting JSON with langlib functions"
            href="/learn/by-example/converting-json-with-langlib-functions"
          >
