...
export function CdcService({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>Change Data Capture - Consume events</h1>

      <p>
        The <code>cdc:Service</code> connects to a MySQL database using the{" "}
        <code>mysql:CdcListener</code>, allowing you to bind change data capture
        (CDC) events directly to subtypes of <code>record&#123;&#125;</code>.
        The listener captures database changes and dispatches them as records to
        one of the <code>onRead</code>, <code>onCreate</code>,{" "}
        <code>onUpdate</code>, or <code>onDelete</code> remote methods in your
        service. To use this, specify the required payload type as the argument
        to these methods, which should be a subtype of{" "}
        <code>record&#123;&#125;</code>. When new CDC events are received, the
        method corresponding to the operation is invoked. If the payload does
        not match the defined type, a <code>cdc:PayloadBindingError</code> will
        be logged. You can customize error handling by implementing the optional{" "}
        <code>onError</code> remote method in your service.
      </p>
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run cdc_service.bal`}</span>
              <span>{`time=2025-05-27T22:17:45.632+05:30 level=INFO module="" message="Fraud detected! Transaction Id: 2, User Id: 11, Amount: \$12000.0"`}</span>
            </code>
          </pre>
        </Col>
      </Row>
      ...
      <blockquote>
        <p>
          ...
          the <code>test_cdc_listener.bal</code> file provided in the{" "}
          <a href="https://github.com/ballerina-platform/ballerina-distribution/tree/master/examples/cdc-prerequisite">
            Change Data Capture Ballerina By Example - Prerequisites and Test
            Data
          </a>
      ...
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
        <li>
          <span>&#8226;&nbsp;</span>
          <span>
            <a href="https://github.com/ballerina-platform/module-ballerinax-cdc/blob/main/docs/spec/spec.md">
