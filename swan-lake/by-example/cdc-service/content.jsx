...
export function CdcService({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>Change Data Capture - Listen to Database</h1>
      ...
      <p>
        If the payload does not match the defined type, a{" "}
        <code>cdc:PayloadBindingError</code> will be logged. You can customize
        error handling by implementing the optional <code>onError</code> remote
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/cdc-service",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              ...
              <span>{`time=2025-05-27T22:17:45.632+05:30 level=INFO module="" message="Fraud detected! Id: 2, User Id: 11, Amount: \$12000.0"`}</span>
            </code>
          </pre>
        </Col>
      </Row>
