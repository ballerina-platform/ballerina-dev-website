...
<p><code>check E</code> is used with an expression <code>E</code> that might result in an <code>error</code> value. If <code>E</code> results in an <code>error</code> value , then, <code>check</code> makes the function return that <code>error</code> value immediately.</p>


<p>The type of <code>check E</code> does not include <code>error</code>. The control flow remains explicit.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/check-expression", "_blank");
      }}
