...
export function ClientClass({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        The <code>client</code> keyword is used with class definition to define
        a client class. Ballerina supports defining client objects to allow a
        program to interact with remote network services. They are a special
        kind of object that contain <code>remote</code> and{" "}
        <code>resource</code> methods in addition to regular methods.
      </p>

      <p>
        Similarly, class objects can be constructed using an object constructor
        as well.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/client-class",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run client_class.bal`}</span>
...
`}</span>
      ...
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
        <li>
          <span>&#8226;&nbsp;</span>
          <span>
            <a href="/learn/by-example/resource-methods/">Resource methods</a>
          </span>
        </li>
      </ul>
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
