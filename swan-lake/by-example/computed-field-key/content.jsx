...
export function ComputedFieldKey({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        Ballerina allows you to have computed values as keys in a map. This can
        be done by specifying the key as an expression within square brackets.
      </p>

      <p>
        This is particularly useful when you want to define and use constants
        for key values.
      </p>
        ...
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
<<<<<<< HEAD
                "https://play.ballerina.io/?gist=1e9d95c9471e84fe962b36fd76ec9026&file=computed_field_key.bal",
=======
                "https://play.ballerina.io/?gist=71ee31de9669cab9f7301d97a8482b6f&file=computed_field_key.bal",
>>>>>>> 4544b7b84e3fbafce0347071b7db377f1be8adda
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.7.0/examples/computed-field-key",
                "_blank",
              );
            }}
