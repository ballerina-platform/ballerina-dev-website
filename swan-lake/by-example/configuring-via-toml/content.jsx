...
<p>The values of the configurable variables can be configured through the configuration files in the TOML(v0.4) format.</p>


<p>The file location can be specified through an environment variable with the name <code>BAL_CONFIG_FILES</code>. Specifying multiple configuration files is supported using this environment variable with the OS-specific separator. If an environment variable is not specified, a file named <code>Config.toml</code> will be sought in the current working directory.</p>


<p>An environment variable with the name <code>BAL_CONFIG_DATA</code> can be used to provide the configuration file content instead of a separate file.</p>


<p>For more information, see <a href="/learn/configure-ballerina-programs/provide-values-to-configurable-variables/#provide-via-toml-syntax/">Configure via TOML syntax</a>.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/configuring-via-toml", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run configuring_via_toml.bal`}</span>
