...
<p>Validating user input is a common requirement in most applications.  This can prevent user entry errors before the app attempts to process the data.</p>


<p>The <code>constraint</code> library provides such validations for the following Ballerina types: <code>int</code>, <code>float</code>, <code>decimal</code>, <code>string</code>, and <code>anydata[]</code>.</p>


<p>For more information on the underlying module, see the <a href="https://lib.ballerina.io/ballerina/constraint/latest/"><code>constraint</code> module</a>.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/constraint-validations", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run constraint_validations.bal`}</span>
