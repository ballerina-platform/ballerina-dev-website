...
export function ConvertingFromJsonToUserDefinedType({ codeSnippets }) {
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=65de51bceed19bea9ef7e77918e054ad&file=converting_from_json_to_user_defined_type.bal",
                "_blank"
              );
            }}
            target="_blank"
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.3.1/examples/converting-from-json-to-user-defined-type",
                "_blank"
              );
            }}
