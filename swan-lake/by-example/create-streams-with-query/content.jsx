  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        ...
        should be preceded by the <code>stream</code> keyword in this case. If
        the expected stream type is <code>stream&lt;T&gt;</code>, then, the{" "}
        <code>select</code> clause must return values belonging to{" "}
        <code>T</code>.
      </p>

      <p>
        When constructing a stream from a query expression, clauses in the query
        expression are executed lazily that are called as a result of the next
        operations being performed on the constructed stream. The failure of the{" "}
        <code>check</code> within the query will cause the stream to produce an
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "vscode://wso2.ballerina/open-file?repoFileUrl=https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.8.2/examples/create-streams-with-query/create_streams_with_query.md",
                "_blank",
              );
            }}
            target="_blank"
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.8.2/examples/create-streams-with-query",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run create_streams_with_query.bal`}</span>
