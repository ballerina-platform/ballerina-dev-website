...
export function CreateTablesWithQuery({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        A query expressions can be used to create tables from an iterable value.
        One way of doing this is specifying <code>table</code> keyword as the
        query construct type before the query expression. The key of the created
        table can be specified explicitly. Second way is to provide a
        contextually expected type. The <code>select</code> clause must emit
        values belonging to <code>map&lt;any|error&gt;</code>.
      </p>
        ...
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
<<<<<<< HEAD
                "https://play.ballerina.io/?gist=dd380f75705e73d77ef9193cf431c7a2&file=create_tables_with_query.bal",
=======
                "https://play.ballerina.io/?gist=7690b148d54b13e6418fcb9b17434d89&file=create_tables_with_query.bal",
>>>>>>> 4544b7b84e3fbafce0347071b7db377f1be8adda
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.7.0/examples/create-tables-with-query",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run create_tables_with_query.bal`}</span>
