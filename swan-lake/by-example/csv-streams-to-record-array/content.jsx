...
export function CsvStreamsToRecordArray({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>Parse CSV byte stream to Ballerina record array</h1>

      <p>
        The Ballerina <code>data.csv</code> library allows parsing the CSV byte
        streams as arrays of Ballerina records, making it easier to process CSV
        data directly from <code>streams</code>. This functionality supports
        data projection, enabling developers to extract and map only the
        required fields to the target <code>record</code> type.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/csv-streams-to-record-array",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run csv_streams_to_record_array.bal`}</span>
