...
export function CsvUserConfigurations({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>Handle CSV with custom configurations</h1>

      <p>
        Ballerina provides flexible CSV data handling through custom
        configurations, enabling developers to define delimiters, escape
        characters, and skip specific lines. This approach allows efficient
        parsing and transformation of CSV files, streamlining the integration
        process.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.13.5/examples/csv-user-configurations",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run csv_user_configurations.bal`}</span>
              <span>{`[{"id":1,"name":"O"Connor","department":"Engineering"},{"id":3,"name":"Jane","department":"Finance"}]`}</span>
              <span>{`[{"id":1,"department":"Engineering"},{"id":3,"department":"Finance"}]`}</span>
            </code>
          </pre>
        </Col>
      </Row>
      ...
      <Row className="mt-auto mb-5">
        ...
        <Col sm={6}>
          <Link
            title="Parse Excel file to records"
            href="/learn/by-example/xlsx-to-records/"
          >
