...
export function CustomLogger({ codeSnippets }) {
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/custom-logger",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run custom_logger.bal`}</span>
              <span>{`
`}</span>
              <span>{`time=2025-08-26T09:04:14.761+05:30 level=INFO module="" message="[Application: OrderService v2.1.0] Application logger initialized" feature="order_processing"`}</span>
              <span>{`time=2025-08-26T09:04:14.776+05:30 level=INFO module="" message="[Application: OrderService v2.1.0] Processing order" orderId="ORDER-12345" customerId="CUST-67890"`}</span>
              <span>{`time=2025-08-26T09:04:14.778+05:30 level=INFO module="" message="[Application: OrderService v2.1.0] Application processing completed"`}</span>
            </code>
          </pre>
        </Col>
      </Row>
      ...
      <blockquote>
        <p>
          <strong>Note:</strong> In this example, the log module print methods
          are used to simulate the logging behaviour. So the root logger
          configurations will be applied to the log messages. But in a real
          world scenario, you would implement the actual logging logic inside
          the custom logger methods with custom log formats and destinations.
        </p>
      </blockquote>

      <p>
        The custom logger implementation allows for flexible and reusable
        logging strategies tailored to specific application needs.
      </p>
      ...
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
        <li>
          <span>&#8226;&nbsp;</span>
          <span>
            <a href="https://ballerina.io/spec/log/#41-logger">
