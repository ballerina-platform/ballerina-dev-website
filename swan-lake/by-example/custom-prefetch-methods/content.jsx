...
export function CustomPrefetchMethods({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>GraphQL service - Custom prefetch methods</h1>

      <p>
        A prefetch method in the context of Ballerina GraphQL is a method that
        is invoked before the actual resolver method. By default the prefetch
        method name has the convention of having the prefix <code>pre</code>{" "}
        followed by the resolver method name.
      </p>

      <p>
        If you want to use a custom prefetch method, the{" "}
        <code>prefetchMethodName</code> field of the{" "}
        <code>graphql:ResourceConfig</code> annotation can be used to override
        the default prefetch method name. This configuration is useful when the
        Query and Mutation operations have fields with the same name, and when
        it is required to use different prefetch methods for each field. To
        override the default prefetch method name, annotate the target field
        with the <code>graphql:ResourceConfig</code> annotation and specify the
        prefetch method name as the value of the <code>prefetchMethodName</code>{" "}
        field.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/custom-prefetch-methods",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run graphql_prefetch_config.bal`}</span>
            </code>
          </pre>
        </Col>
      </Row>
      ...
      >
        ...
        <Col sm={12}>
          <pre ref={ref2}>
            <code className="d-flex flex-column">
              <span>{`\$ curl 'http://localhost:9090/graphql' -H 'Content-Type: application/json' -d '{"query": "{ authors { name books { title } } }"}'`}</span>
              <span>{`{"data":{"authors":[{"name":"J.K. Rowling", "books":[{"title":"Harry Potter and the Sorcerer's Stone"}, {"title":"Harry Potter and the Chamber of Secrets"}, {"title":"Harry Potter and the Prisoner of Azkaban"}]}, {"name":"Stephen King", "books":[{"title":"The Shining"}, {"title":"It"}, {"title":"The Stand"}]}]}}`}</span>
            </code>
          </pre>
        </Col>
      </Row>
      ...
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
        <li>
          <span>&#8226;&nbsp;</span>
          <span>
            <a href="https://lib.ballerina.io/ballerina/graphql/latest#ResourceConfig">
              <code>graphql:ResourceConfig</code> annotation - API documentation
            </a>
          </span>
        </li>
      </ul>
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
        <li>
          <span>&#8226;&nbsp;</span>
          <span>
            <a href="/spec/graphql/#722-prefetch-method-name-configuration">
              Prefetch Method Name Configuration - Specification
            </a>
          </span>
        </li>
      </ul>
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
        <li>
          <span>&#8226;&nbsp;</span>
          <span>
            <a href="/spec/graphql/#10633-define-the-corresponding-prefetch-method">
              The <code>prefetch</code> Method - Specification
            </a>
          </span>
        </li>
      </ul>
