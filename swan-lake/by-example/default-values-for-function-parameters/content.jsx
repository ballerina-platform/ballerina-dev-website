      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=ba4c6adb3d6db5c5cfb0c2a49b40e83f&file=default_values_for_function_parameters.bal",
                "_blank"
              );
            }}
            target="_blank"
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/default-values-for-function-parameters",
                "_blank"
              );
            }}
