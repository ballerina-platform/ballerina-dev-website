      ...
      <Row className="bbeCode px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
        ...
        <Col className="d-flex align-items-start pt-2" sm={2}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=e09b377aebea9bfd5baa6ae5eefcee2f&file=defining_classes.bal",
                "_blank"
              );
            }}
            target="_blank"
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.0.3/defining-classes",
                "_blank"
              );
            }}
