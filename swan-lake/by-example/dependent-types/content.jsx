...
export function DependentTypes({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        Ballerina supports a concept called dependent types that makes the
        return type of a function dependent on the value of a parameter. Unlike
        the normal convention where the return type is defined independently,
        here the return type depends on a parameter which is a type descriptor.
        When the parameter has a default value of <code>&lt;&gt;</code> the
        compiler infers the argument for the parameter from the function call
        context.
      </p>
        ...
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
<<<<<<< HEAD
                "https://play.ballerina.io/?gist=5801c0539a5641cbdeea2c205d58307c&file=dependent_types.bal",
=======
                "https://play.ballerina.io/?gist=5c77190153934a363a1167e6ded115ee&file=dependent_types.bal",
>>>>>>> 4544b7b84e3fbafce0347071b7db377f1be8adda
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.7.0/examples/dependent-types",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run dependent_types.bal`}</span>
              <span>{`Ballerina`}</span>
              <span>{`12.5`}</span>
            </code>
          </pre>
