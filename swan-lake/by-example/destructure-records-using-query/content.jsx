...
export function DestructureRecordsUsingQuery({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        Destructuring records is particularly useful with the query expressions.
        But works anywhere you can have <code>var</code>. <code>var</code> is
        followed by a binding pattern. You can also specify the type explicitly
        before the binding pattern without using <code>var</code>.
      </p>

      <p>
        <code>&#123;x&#125;</code> is short for <code>&#123;x: x&#125;</code> in
        both binding patterns and record constructors.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "vscode://wso2.ballerina/open-file?repoFileUrl=https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.8.2/examples/destructure-records-using-query/destructure_records_using_query.md",
                "_blank",
              );
            }}
            target="_blank"
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.8.2/examples/destructure-records-using-query",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run destructuring_records_with_query.bal`}</span>
