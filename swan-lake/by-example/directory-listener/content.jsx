...
export default function DirectoryListener() {
  ...
  return (
    <Container className="d-flex flex-column h-100">
      ...
      <p>
        The <code>Directory Listener</code> is used to listen to a directory in
        the local file system.
      </p>

      <p>
        It notifies when new files are created in the directory or when the
        existing files are deleted or modified.&lt;br/&gt;&lt;br/&gt;
      </p>
      ...
      <Row className="bbeCode px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
        ...
        <Col className="d-flex align-items-start pt-2" sm={2}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.0.3/directory-listener",
                "_blank"
              );
            }}
      ...
      <Row className="bbeOutput p-2 rounded">
        <pre className="m-0">
          <code className="d-flex flex-column">
            <span>
              {`# After running the sample, create a new file called `}
              <code>{`test1.txt`}</code>
              {` in the directory called `}
              <code>{`observed-dir`}</code>
