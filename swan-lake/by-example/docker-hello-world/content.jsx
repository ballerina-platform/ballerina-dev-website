...
export function DockerHelloWorld({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        Ballerina supports generating Docker artifacts from code without any
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/docker-hello-world",
                "_blank",
              );
            }}
      ...
      <p>
        ...
        taken by the compiler. To do this, create a file named{" "}
...
`}</span>
      ...
      >
        ...
        <Col sm={12}>
          <pre ref={ref4}>
            <code className="d-flex flex-column">
              <span>{`\$ curl http://localhost:9090/helloWorld/sayHello`}</span>
