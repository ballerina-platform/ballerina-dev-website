      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=f4e378cf236d95c2b37ef6c8e04d0659&file=schema.json",
                "_blank"
              );
            }}
            target="_blank"
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=bfa27012a34c3457c8a996b4f6797e31&file=edi_to_record.bal",
                "_blank"
              );
            }}
            target="_blank"
