      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=5b0ddb71234b591d3999952aabef1750&file=schema.json",
                "_blank",
              );
            }}
            target="_blank"
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=956b2eba8faa1076aee037bd970b9dfe&file=edi_to_record.bal",
                "_blank",
              );
            }}
            target="_blank"
