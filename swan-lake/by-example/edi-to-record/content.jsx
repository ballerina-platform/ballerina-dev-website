      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=70fedbb8652501e13dda232f076b7054&file=schema.json",
                "_blank"
              );
            }}
            target="_blank"
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=b713ca9921f13aae09013c7c985ae371&file=edi_to_record.bal",
                "_blank"
              );
            }}
            target="_blank"
