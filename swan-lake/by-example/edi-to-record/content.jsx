  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        ...
        them to Ballerina records, so that all operations related to Ballerina
        records can be applied on EDI data as well (e.g. transforming EDI data,
        writing EDI data to databases, transering EDI data over various network
        protocols, etc.).
      </p>

      <p>
        First, it is necessary to write a schema for the EDI data type that
        needs to be processed. Below is a simple EDI schema for sales order
        data. According to the schema, data must begin with a <code>HDR</code>{" "}
        segment followed by zero or more <code>ITM</code> segments.{" "}
        <code>HDR</code> segment contains four fields: <code>code</code>,{" "}
        <code>orderId</code>, <code>organization</code>, and <code>date</code>.{" "}
        <code>ITM</code> segment has three fields: <code>code</code>,{" "}
        <code>item</code>, and <code>quantity</code>.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "vscode://wso2.ballerina/open-file?repoFileUrl=https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.8.2/examples/edi-to-record/edi_to_record.md",
                "_blank",
              );
            }}
            target="_blank"
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.8.2/examples/edi-to-record",
                "_blank",
              );
            }}
      ...
      <p>
        Create a new Ballerina project named <code>edi_to_record</code> and
        create a module named <code>sorder</code> inside that project by using
        the below commands.
      </p>
      ...
      <p>
        Create a new folder named <code>resources</code> in the root of the
        project and copy the schema file into it. At this point, directory
      ...
      <blockquote>
        <p>
          Note that it is recommended to place generated code for each EDI
          schema in a separate module in order to avoid conflicts.
        </p>
      </blockquote>

      <p>
        Write a Ballerina program by using generated methods and records to work
        with EDI data.
      </p>
        ...
        <Col sm={12}>
          <pre ref={ref4}>
            <code className="d-flex flex-column">
              ...
              <span>{`Item: A-250, Quantity: 12`}</span>
              <span>{`Item: A-45, Quantity: 100`}</span>
              <span>{`Item: D-10, Quantity: 58`}</span>
              <span>{`Item: K-80, Quantity: 250`}</span>
              <span>{`Item: T-46, Quantity: 28`}</span>
            </code>
          </pre>
        </Col>
      </Row>
