...
export function EmailClientSslTls({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        The <code>email:ImapClient</code> can be configured to communicate
        through SSL/TLS by providing a certificate file. The certificate can be
        provided through the <code>secureSocket</code> field of the client
        configuration. In addition to the certificate configuration, an optional{" "}
        <code>security</code> configuration is available to define the
        underlying transport protocol which needs to be used. The Ballerina{" "}
        <code>email</code> module supports both <code>STARTTLS</code> and{" "}
        <code>SSL</code> as the transport protocol. Use this to interact with
        email servers based on SSL/TLS encrypted secured connection.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/email-client-ssl-tls",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run email_client_ssl_tls.bal`}</span>
            </code>
          </pre>
        </Col>
      </Row>
