...
const ref1 = createRef()
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1><code>ensureType</code> function</h1>


<p>The <code>ensureType()</code> function is a lang library function that is similar to a cast. It takes a <code>typedesc</code> value as an argument. It returns an error if the cast is not possible.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/ensureType-function", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run ensureType_function.bal`}</span>
<span>{`12.5`}</span>
