...
export function ErrorBindingPatternInMatchStatement({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        Error binding patterns can be used in a match statement to bind parts of
        a successful match of an error value to variables. You can use the rest
        binding pattern (<code>...r</code>) in the error binding pattern of a
        match statement to bind the detail mapping fields that are not
        explicitly bound in the binding pattern.
      </p>
        ...
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
<<<<<<< HEAD
                "https://play.ballerina.io/?gist=b92fa223a3b8baae9c11fe486a918bf2&file=error_binding_pattern_in_match_statement.bal",
=======
                "https://play.ballerina.io/?gist=ebd7f7daf2f915930c2cac7843e53145&file=error_binding_pattern_in_match_statement.bal",
>>>>>>> 4544b7b84e3fbafce0347071b7db377f1be8adda
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.7.0/examples/error-binding-pattern-in-match-statement",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run error_binding_pattern_in_match_statement.bal`}</span>
