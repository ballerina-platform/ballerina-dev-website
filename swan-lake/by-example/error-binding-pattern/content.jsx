...
export function ErrorBindingPattern({codeSnippets}) {
...
const ref1 = createRef()
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>Error binding pattern</h1>


<p>An error binding pattern matches the different elements of an error value such as the error message, error cause, and error detail mapping. It can also be used to destructure the reason, cause, and detail mapping values from an error value, and assign them to the existing variable references.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/error-binding-pattern", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run error_binding_pattern.bal`}</span>
<span>{`Cause: error("Database Error")`}</span>
<span>{`Info: 20`}</span>
<span>{`Fatal: deadlock condition`}</span>
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="/learn/by-example/rest-binding-pattern-in-error-binding-pattern/">Rest binding pattern in error binding pattern</a></span>
                        </li>
