...
export function ErrorDetail({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        Error detail is a map that contains arbitrary extra details about the
        context of the error. The <code>error&lt;T&gt;</code> type describes an
        error value with a detail map that has the type <code>T</code>. Named
        arguments of the error constructor specify the fields of the detail
        record. An immutable copy of each field is made in the detail record
        using the <code>cloneReadOnly</code> function.
      </p>
        ...
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
<<<<<<< HEAD
                "https://play.ballerina.io/?gist=a9dd318f94dbca2e64871680460b9dfb&file=error_detail.bal",
=======
                "https://play.ballerina.io/?gist=34d795e71e6a18c63501d4b2c427f06f&file=error_detail.bal",
>>>>>>> 4544b7b84e3fbafce0347071b7db377f1be8adda
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.7.0/examples/error-detail",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run error_detail.bal`}</span>
