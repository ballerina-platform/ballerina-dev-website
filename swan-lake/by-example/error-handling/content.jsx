...
<p>Usually, a function handles errors by passing them up to its caller. The <code>main</code> function can also return an <code>error</code> value.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/error-handling", "_blank");
      }}
