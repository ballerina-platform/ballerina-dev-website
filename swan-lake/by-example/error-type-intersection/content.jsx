...
<p>You can define an error type that is both a subtype of a <code>distinct</code> error type and has additional constraints on the detail fields using intersection types.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/error-type-intersection", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run error_type_intersection.bal`}</span>
<span>{`true`}</span>
<span>{`true`}</span>
<span>{`false`}</span>
<span>{`false`}</span>
