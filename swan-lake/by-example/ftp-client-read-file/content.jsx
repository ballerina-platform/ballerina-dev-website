  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        ...
        the matching type from the FTP server. <code>getJson</code>,{" "}
        <code>getXml</code>, and <code>getCsv</code> bind the content to the
        type expected at the call site. Use this to transfer files from a remote
        file system to a local file system.
      </p>
      ...
      <ul style={{ marginLeft: "0px" }}>
        <li>
          ...
          <span>
            ...
            <a href="/learn/by-example/ftp-client-write-file">
