...
service on remoteServer {
    ...
    remote method onFileChange(ftp:WatchEvent & readonly event) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.3/examples/ftp-listener",
                "_blank"
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run ftp_listener.bal`}</span>
            </code>
          </pre>
        </Col>
      </Row>
      ...
      <Row className="mt-auto mb-5">
        <Col sm={6}>
          <Link title="Client" href="/learn/by-example/ftp-client">
        ...
        <Col sm={6}>
          <Link title="Client" href="/learn/by-example/sftp-client">
