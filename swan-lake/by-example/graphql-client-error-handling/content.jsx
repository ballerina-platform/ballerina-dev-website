...
export function GraphqlClientErrorHandling({codeSnippets}) {
...
<p>The <code>graphql:Client</code> allows handling different errors occurred when executing the <code>execute</code> method. It returns a <code>graphql:ClientError</code> error, which has different subtypes that can be handled differently based on the use case. Use the subtypes of the <code>graphql:ClientError</code> to handle different types of errors based on the use case.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/graphql-client-error-handling", "_blank");
      }}
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span>Run the GraphQL service given in the <a href="https://ballerina.io/learn/by-example/graphql-mutations/">Mutations</a> example.</span>
                        </li>
                    </ul>
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run graphql_client_error_handling.bal`}</span>
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="https://lib.ballerina.io/ballerina/graphql/latest#ClientError"><code>graphql:ClientError</code> error - API documentation</a></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} class="relatedLinks">
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="/spec/graphql/#255-client-error-handling">GraphQL client error handling - Specification</a></span>
                        </li>
