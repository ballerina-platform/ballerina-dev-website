...
export default function GraphqlClientErrorHandling() {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>GraphQL client - Error handling</h1>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.0/examples/graphql-client-error-handling",
                "_blank"
              );
            }}
      ...
      <ul style={{ marginLeft: "0px" }}>
        <li>
          ...
          <span>
            ...
            <a href="https://ballerina.io/learn/by-example/graphql-mutations/">
              Mutations
            </a>{" "}
            example.
          </span>
