...
export function GraphqlClientSecurityMutualSsl({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        This example shows how to send a GraphQL request securely using mutual
        SSL.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.3.2/examples/graphql-client-security-mutual-ssl",
                "_blank"
              );
            }}
      ...
      <ul style={{ marginLeft: "0px" }}>
        <li>
          ...
          <span>
            ...
            <a href="https://ballerina.io/learn/by-example/graphql-service-mutual-ssl">
              Mutual SSL
            </a>{" "}
            example.
          </span>
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run graphql_client_security_mutual_ssl.bal`}</span>
      ...
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
        <li>
          <span>&#8226;&nbsp;</span>
          <span>
            <a href="/spec/graphql/#11322-mutual-ssl">
              GraphQL client mutual SSL - Specification
            </a>
          </span>
        </li>
      </ul>
