...
export default function GraphqlClientSecurityOauth2PasswordGrantType() {
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.0/examples/graphql-client-security-oauth2-password-grant-type",
                "_blank"
              );
            }}
