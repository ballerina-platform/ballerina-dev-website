  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        ...
        provided, an empty context object will be created. The context can be
        accessed by defining it as the first parameter of any resolver
        (resource/remote) function.
      </p>
      ...
      <p>
        ...
        to <code>user</code>. This will return an error in the{" "}
        <code>salary</code> field.
      </p>
      ...
      <p>
        Then, send the same document with the <code>scope</code> header value
        set to <code>unknown</code>. This will return an error in the{" "}
