...
export function GraphqlDataloader({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>GraphQL service - Dataloader</h1>

      <p>
        The Ballerina GraphQL module provides the capability to batch and cache
        data fetching from data sources using the{" "}
        <code>graphql.dataloader</code> submodule. To leverage this
        functionality in a GraphQL service, you must register data loaders
        through the <code>graphql:Context</code> object and implement the
        corresponding prefetch method logic and resolver method logic.
      </p>
      ...
      <p>
        ...
        method name follows the convention of having the prefix <code>pre</code>
        , followed by the resolver method name. The use of{" "}
        <code>graphql.dataloader</code> avoids excessive data fetching,
        effectively addressing the GraphQL N+1 problem.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/graphql-dataloader",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run graphql_dataloader.bal`}</span>
              <span>{`time = 2023-08-08T13:58:40.479+05:30 level = INFO module = "" message = "executing bookLoaderFunction" keys = [1,2]`}</span>
            </code>
          </pre>
        </Col>
      </Row>
      ...
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
        <li>
          <span>&#8226;&nbsp;</span>
          <span>
            <a href="https://lib.ballerina.io/ballerina/graphql.dataloader/latest">
              <code>garaphql.dataloader</code> module - API documentation
            </a>
          </span>
        </li>
      </ul>
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
        <li>
          <span>&#8226;&nbsp;</span>
          <span>
            <a href="/spec/graphql/#106-dataloader">
