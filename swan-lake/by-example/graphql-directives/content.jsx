    ...
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/graphql-directives",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run graphql_directives.bal`}</span>
            </code>
          </pre>
        </Col>
      </Row>
      ...
      >
        ...
        <Col sm={12}>
          <pre ref={ref2}>
            <code className="d-flex flex-column">
              <span>{`\$ curl -X POST -H "Content-type: application/json" -d '{ "query": "{ profile { name, gender @skip(if: true) } }" }' 'http://localhost:9090/graphql'`}</span>
      ...
      <p>
        Then, send the following document containing the <code>@include</code>{" "}
        directive.
      </p>
      ...
      >
        ...
        <Col sm={12}>
          <pre ref={ref3}>
            <code className="d-flex flex-column">
              <span>{`\$ curl -X POST -H "Content-type: application/json" -d '{ "query": "{ profile { name, gender @include(if: true) } }" }' 'http://localhost:9090/graphql'`}</span>
      ...
      <p>
        Finally, send the following document with an introspection query to
        check the deprecated enum values.
      </p>
      ...
      >
        ...
        <Col sm={12}>
          <pre ref={ref4}>
            <code className="d-flex flex-column">
              <span>{`\$ curl -X POST -H "Content-type: application/json" -d '{ "query": "{ __type(name: \\"Gender\\") { name, enumValues(includeDeprecated: true) { name, isDeprecated, deprecationReason } } }" }' 'http://localhost:9090/graphql'`}</span>
