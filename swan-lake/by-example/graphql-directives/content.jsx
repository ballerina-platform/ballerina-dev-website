...
export default function GraphqlDirectives() {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>The following example demonstrates the use of GraphQL directives.</p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.1/examples/graphql-directives",
                "_blank"
              );
            }}
      ...
      <p>
        Invoke the service using the following cURL command to inspect the
        result.
      </p>
