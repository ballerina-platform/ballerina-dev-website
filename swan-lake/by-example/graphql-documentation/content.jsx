...
export default function GraphqlDocumentation() {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        Send the following document with an introspection query to test how the
        documentation is added to the schema.
      </p>
      ...
      >
        ...
        <Col sm={12}>
          <pre ref={ref2}>
            <code className="d-flex flex-column">
              <span>{`\$ curl -X POST -H "Content-type: application/json" -d '{ "query": "{ __schema { queryType { fields { name description type { name description fields { name description } } args { name description } } } } }" }' 'http://localhost:4000/graphql'`}</span>
