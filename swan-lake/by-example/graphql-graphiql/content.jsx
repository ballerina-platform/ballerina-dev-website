  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/graphql-graphiql",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run graphql_graphiql.bal`}</span>
            </code>
          </pre>
        </Col>
      </Row>
      ...
      <p>
        ...
        <code>http://localhost:9090/testing</code>. Following is a sample
      ...
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
        <li>
          <span>&#8226;&nbsp;</span>
          <span>
            <a href="https://lib.ballerina.io/ballerina/graphql/latest#Graphiql">
