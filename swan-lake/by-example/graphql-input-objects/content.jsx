...
export default function GraphqlInputObjects() {
    ...
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.0/examples/graphql-input-objects",
                "_blank"
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run graphql_input_objects.bal`}</span>
            </code>
          </pre>
        </Col>
      </Row>
      ...
      >
        ...
        <Col sm={12}>
          <pre ref={ref2}>
            <code className="d-flex flex-column">
              <span>{`\$ curl -X POST -H "Content-type: application/json" -d '{ "query": "mutation { addPost(newPost: { author: \\"Sam\\", content: \\"Hello\\" }) { id } }" }' 'http://localhost:4000/graphql'`}</span>
