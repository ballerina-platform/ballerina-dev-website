...
export function GraphqlInterfacesImplementingInterfaces({codeSnippets}) {
...
<p>The Ballerina <code>graphql</code> module allows defining GraphQL interface types that can implement other interfaces. A <code>distinct</code> <code>service</code> object must be used to define an interface. The Ballerina type-inclusion is used to define interfaces that implement other interfaces. This can be used in GraphQL schemas to define higher-order interfaces that share common functionalities in the application logic.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/graphql-interfaces-implementing-interfaces", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run graphql_interfaces_implementing_interfaces.bal`}</span>
</code></pre>
          </Col>
        </Row>
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref2}>
      <code className="d-flex flex-column"><span>{`\$ curl -X POST -H "Content-type: application/json" -d '{ "query": "{ profile { name ...on Teacher { school ...on HighSchoolTeacher { subject }}}}" }' 'http://localhost:9090/graphql'`}</span>
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="/spec/graphql/#461-interfaces-implementing-interfaces">GraphQL interfaces implementing interfaces - Specification</a></span>
                        </li>
      ...
      <Link
        title="Interfaces"
        href="/learn/by-example/graphql-interfaces"
      >
