...
export default function GraphqlMutations() {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        This example shows a GraphQL endpoint, which has <code>updateName</code>{" "}
        and <code>updateAge</code> fields in the root <code>Mutation</code>{" "}
        type. Both the fields are of type <code>Person!</code>.
      </p>
      ...
      <p>
        First, send the following document to the GraphQL endpoint to test the
        service.
      </p>
      ...
      <p>Now, send the following document to update the name.</p>
      ...
      <p>Finally, send the following document to update the age.</p>
