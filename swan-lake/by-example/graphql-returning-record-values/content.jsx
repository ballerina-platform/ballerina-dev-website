  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        ...
        an <code>OBJECT</code> type in a GraphQL schema. The type name and the
        field names are mapped one-to-one from the Ballerina to GraphQL. Types
        are generated by analyzing the types that are used in a Ballerina
        GraphQL service recursively. Use a record type to represent an{" "}
        <code>OBJECT</code> type only when all fields of that object type do not
      ...
      <blockquote>
        <p>
          <strong>Note:</strong> A service type can also be used to represent an{" "}
          <code>OBJECT</code> type when the fields in the <code>OBJECT</code>{" "}
          type are having input arguments or the field resolution requires
