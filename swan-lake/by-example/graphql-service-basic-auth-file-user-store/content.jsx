  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        ...
        To engage authentication set the default values to the{" "}
        <code>fileUserStoreConfig</code> field and add the{" "}
        <code>Config.toml</code> file next to the service file. To enable
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/graphql-service-basic-auth-file-user-store",
                "_blank",
              );
            }}
