  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        ...
        <code>error</code>s from the <code>resource</code> and{" "}
        <code>remote</code> methods. When the method returns an{" "}
        <code>error</code>, it is added to the GraphQL response under the{" "}
        <code>errors</code> field whereas the field value is set to{" "}
        <code>null</code> under the <code>data</code> field. However, if the
        return type of the <code>resource</code> or the <code>remote</code> does
        not also include <code>nil</code>, the GraphQL field type becomes{" "}
        <code>NON_NULL</code>. Therefore, the <code>null</code> value is
        propagated to the upper levels until a <code>null</code> value is
        allowed as the field value. This might cause the whole <code>data</code>{" "}
        field in the GraphQL response to be <code>null</code> in some cases. To
        avoid this cascading behavior, the return type should include nil as
        appropriate.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/graphql-service-error-handling",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run graphql_service_error_handling.bal`}</span>
            </code>
          </pre>
        </Col>
      </Row>
      ...
      >
        ...
        <Col sm={12}>
          <pre ref={ref2}>
            <code className="d-flex flex-column">
              <span>{`\$ curl -X POST -H "Content-type: application/json" -d '{ "query": "{ profile(id: 1) { name age } }" }' 'http://localhost:9090/graphql'`}</span>
      ...
      <p>
        Check the response to see how both the <code>errors</code> and the{" "}
        <code>data</code> fields are present in the response.
      </p>
      ...
      >
        ...
        <Col sm={12}>
          <pre ref={ref3}>
            <code className="d-flex flex-column">
              <span>{`\$ curl -X POST -H "Content-type: application/json" -d '{ "query": "{ profile(id: 2) { name age } }" }' 'http://localhost:9090/graphql'`}</span>
      ...
      <p>
        Check the response to see how the <code>data</code> field is set to null
        due to propagating the <code>null</code> value because the{" "}
        <code>name</code> field and the <code>profile</code> field are of{" "}
        <code>NON_NULL</code> type.
      </p>
