...
export function GraphqlServiceFieldLevelCaching({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>GraphQL service - Field-level caching</h1>

      <p>
        The Ballerina <code>graphql</code> module provides the capability to
        enable GraphQL caching, which can be applied at either the field or
        operation level. To enable caching at the field level, the{" "}
        <code>cacheConfig</code> field in the{" "}
        <code>graphql:ResourceConfig</code> annotation can be used on a resource
        method within a <code>graphql:Service</code>. By setting this
        configuration, caching is enabled for the specified GraphQL field, and
        it can override the cache configurations set at the operation level.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/graphql-service-field-level-caching",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run graphql_service_field_level_caching.bal`}</span>
            </code>
          </pre>
        </Col>
      </Row>
      ...
      >
        ...
        <Col sm={12}>
          <pre ref={ref2}>
            <code className="d-flex flex-column">
              <span>{`\$ curl -X POST -H "Content-type: application/json" -d '{ "query": "{ name(id: 1) }" }' 'http://localhost:9090/graphql'`}</span>
              <span>{`{"data":{"name":"Walter White"}}`}</span>
            </code>
          </pre>
        </Col>
      </Row>
      ...
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
        <li>
          <span>&#8226;&nbsp;</span>
          <span>
            <a href="/spec/graphql/#10712-field-level-caching">
              GraphQL Field-level caching - Specification
            </a>
          </span>
        </li>
      </ul>
