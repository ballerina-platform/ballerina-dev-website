...
export function GraphqlServiceOperationLevelCaching({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>GraphQL service - Operation-level caching</h1>

      <p>
        The Ballerina <code>graphql</code> module provides the capability to
        enable GraphQL caching. GraphQL caching can be enabled at either the
        field level or the operation level. To enable caching at the operation
        level, the <code>cacheConfig</code> field in the{" "}
        <code>graphql:ServiceConfig</code> annotation can be applied to a
        service. This configuration will enable caching for all resource paths
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/graphql-service-operation-level-caching",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run graphql_service_operation_level_caching.bal`}</span>
            </code>
          </pre>
        </Col>
      </Row>
      ...
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
        <li>
          <span>&#8226;&nbsp;</span>
          <span>
            <a href="/spec/graphql/#10711-operation-level-caching">
              GraphQL Operation-level caching - Specification
            </a>
          </span>
        </li>
      </ul>
