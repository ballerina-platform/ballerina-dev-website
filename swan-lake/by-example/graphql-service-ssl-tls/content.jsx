...
export default function GraphqlServiceSslTls() {
  ...
  return (
    <Container className="d-flex flex-column h-100">
      ...
      <p>
        Provide the <code>graphql:ListenerSecureSocket</code> configurations to
        the server to
      </p>
      ...
      >
        ...
        <Col className="d-flex align-items-start pt-2" sm={2}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.1/examples/graphql-service-ssl-tls",
                "_blank"
              );
            }}
