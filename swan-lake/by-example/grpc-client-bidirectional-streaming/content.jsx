      ...
      <ul style={{ marginLeft: "0px" }}>
        <li>
          ...
          <span>
            ...
            <code>grpc_bidirectional_streaming.proto</code> and add the service
            definition below.
          </span>
        </li>
      </ul>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/grpc-client-bidirectional-streaming",
                "_blank",
              );
            }}
        ...
        <li>
          ...
          <span>
            <a href="/spec/grpc/#44-bidirectional-streaming-rpc">
              gRPC client bidirectional streaming - Specification
            </a>
          </span>
        </li>
      </ul>
