...
export default function GrpcClientBidirectionalStreaming() {
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.0/examples/grpc-client-bidirectional-streaming",
                "_blank"
              );
            }}
