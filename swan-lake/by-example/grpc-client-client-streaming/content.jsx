...
export default function GrpcClientClientStreaming() {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>Client - Client streaming RPC</h1>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.0/examples/grpc-client-client-streaming",
                "_blank"
              );
            }}
      ...
      <ul style={{ marginLeft: "0px" }}>
        <li>
          <span>3.</span>
          <span>
            Create a new <code>grpc_client_streaming_client.bal</code> file
