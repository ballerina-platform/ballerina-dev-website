  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        ...
        with the OAuth2 client credentials grant type by enriching client
        ...
        in the <code>auth</code> field of the client configuration.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/grpc-client-oauth2-client-credentials-grant-type",
                "_blank",
              );
            }}
      ...
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
        <li>
          <span>&#8226;&nbsp;</span>
          <span>
            <a href="https://lib.ballerina.io/ballerina/grpc/latest#OAuth2ClientCredentialsGrantConfig">
              <code>grpc:OAuth2ClientCredentialsGrantConfig</code> record - API
              documentation
            </a>
          </span>
        </li>
