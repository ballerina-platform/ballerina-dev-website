  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        ...
        with the OAuth2 JWT bearer grant type by enriching the client metadata
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/grpc-client-oauth2-jwt-bearer-grant-type",
                "_blank",
              );
            }}
