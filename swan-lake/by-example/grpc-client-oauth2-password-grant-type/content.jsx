...
// header by passing the [\`grpc:OAuth2PasswordGrantConfig\`](https://lib.ballerina.io/ballerina/grpc/latest/records/OAuth2PasswordGrantConfig) to the \`auth\`
...
export default function GrpcClientOauth2PasswordGrantType() {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        header by passing the <code>grpc:OAuth2PasswordGrantConfig</code> to the{" "}
      ...
      <Row className="bbeCode mx-0 py-0 rounded" style={{ marginLeft: "32px" }}>
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.1/examples/grpc-client-oauth2-password-grant-type",
                "_blank"
              );
            }}
      ...
      <ul style={{ marginLeft: "0px" }}>
        <li>
          <span>3.</span>
          <span>
            Create a new <code>grpc_client_oauth2_password_grant_type.bal</code>{" "}
