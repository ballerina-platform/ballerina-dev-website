...
export default function GrpcClientSelfSignedJwtAuth() {
  ...
  return (
    <Container className="d-flex flex-column h-100">
      ...
      <p>
        of the client. A self-signed JWT is issued before the request is
        sent.&lt;br/&gt;&lt;br/&gt;
      </p>
      ...
      <Row className="bbeCode px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
        ...
        <Col className="d-flex align-items-start pt-2" sm={2}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.0.3/grpc-client-self-signed-jwt-auth",
                "_blank"
              );
            }}
