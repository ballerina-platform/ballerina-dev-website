    ...
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.3.0/examples/grpc-client-self-signed-jwt-auth",
                "_blank"
              );
            }}
      ...
      <ul style={{ marginLeft: "0px" }}>
        <li>
          ...
          <span>
            Create a new{" "}
            <code>grpc_client_oauth2_refresh_token_grant_type.bal</code>{" "}
      ...
      <pre>
        <code>
          &gt;**Info:** As a prerequisite to running the client, start the [JWT
          Auth service](/learn/by-example/grpc-service-jwt-auth/).
        </code>
      </pre>
