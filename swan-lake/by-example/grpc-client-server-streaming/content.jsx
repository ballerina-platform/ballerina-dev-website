    ...
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/grpc-client-server-streaming",
                "_blank",
              );
            }}
      ...
      <ul style={{ marginLeft: "0px" }}>
        <li>
          ...
          <span>
            ...
            from the <code>stubs</code> directory to the <code>client</code>{" "}
            package.
          </span>
        </li>
      </ul>
      ...
      <ul style={{ marginLeft: "0px" }}>
        <li>
          <span>3.</span>
          <span>
            Create a new <code>grpc_server_streaming_client.bal</code> file
        ...
        <li>
          ...
          <span>
            <a href="/spec/grpc/#42-server-streaming-rpc">
              gRPC client server-side streaming - Specification
            </a>
          </span>
        </li>
      </ul>
