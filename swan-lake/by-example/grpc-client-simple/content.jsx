  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        ...
        gRPC server. In the simple RPC scenario, once connected, the client
        sends a request message to the remote service and waits for the response
        message. Use this to send a single request message and get a single
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/grpc-client-simple",
                "_blank",
              );
            }}
      ...
      <ul style={{ marginLeft: "0px" }}>
        <li>
          <span>2.</span>
          <span>
            Copy the generated <code>grpc_simple_pb.bal</code> file from the{" "}
      ...
      <ul style={{ marginLeft: "0px" }}>
        <li>
          <span>3.</span>
          <span>
            Create a new <code>grpc_simple_client.bal</code> file inside the{" "}
        ...
        <li>
          ...
          <span>
            <a href="/spec/grpc/#41-simple-rpc">
              gRPC client simple RPC - Specification
            </a>
          </span>
        </li>
      </ul>
