  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/grpc-client-ssl-tls",
                "_blank",
              );
            }}
        ...
        <li>
          ...
          <span>
            <a href="/spec/grpc/#52-ssltls-and-mutual-ssl">
              gRPC client SSL/TLS - Specification
            </a>
          </span>
        </li>
      </ul>
      ...
      <Row className="mt-auto mb-5">
        <Col sm={6}>
          <Link title="OAuth2" href="/learn/by-example/grpc-service-oauth2/">
