...
export function GrpcServerReflection({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/grpc-server-reflection",
                "_blank",
              );
            }}
      ...
      <p>
        After running the service, you can use a tool like{" "}
        ...
        ,{" "}
        <a href="https://github.com/ktr0731/evans">
          <code>evans CLI</code>
        </a>{" "}
      ...
      >
        ...
        <Col sm={12}>
          <pre ref={ref2}>
            <code className="d-flex flex-column">
              <span>{`\$ ./grpcurl -use-reflection -plaintext localhost:9090 describe`}</span>
