      ...
      <Row className="bbeCode px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
        ...
        <Col className="d-flex align-items-start pt-2" sm={2}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.0.3/grpc-service-basic-auth-file-user-store",
                "_blank"
              );
            }}
      ...
      <Row className="bbeOutput p-2 rounded">
        <pre className="m-0">
          <code className="d-flex flex-column">
            ...
            <span>
              {`# Create a new `}
              <code>{`grpc_service_basic_auth_file_user_store.bal`}</code>
