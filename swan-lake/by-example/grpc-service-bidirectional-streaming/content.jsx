...
export default function GrpcServiceBidirectionalStreaming() {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>Service - Bidirectional streaming RPC</h1>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.0/examples/grpc-service-bidirectional-streaming",
                "_blank"
              );
            }}
