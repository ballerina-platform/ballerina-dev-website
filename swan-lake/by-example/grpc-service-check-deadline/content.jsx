    ...
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/grpc-service-check-deadline",
                "_blank",
              );
            }}
      ...
      <blockquote>
        <p>
          ...
          <a href="/learn/by-example/grpc-client-set-deadline/">
