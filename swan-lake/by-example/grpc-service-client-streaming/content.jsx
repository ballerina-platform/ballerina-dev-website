    ...
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/grpc-service-client-streaming",
                "_blank",
              );
            }}
      ...
      <ul style={{ marginLeft: "0px" }}>
        <li>
          <span>2.</span>
          <span>
            Copy the generated <code>grpc_client_streaming_pb.bal</code> file
            from the <code>stubs</code> directory to the <code>service</code>{" "}
            package.
          </span>
        </li>
      </ul>
      ...
      <ul style={{ marginLeft: "0px" }}>
        <li>
          <span>3.</span>
          <span>
            Create a new <code>grpc_client_streaming.bal</code> file inside the{" "}
        ...
        <li>
          ...
          <span>
            <a href="/spec/grpc/#43-client-streaming-rpc">
              gRPC service client-side streaming - Specification
            </a>
          </span>
        </li>
      </ul>
