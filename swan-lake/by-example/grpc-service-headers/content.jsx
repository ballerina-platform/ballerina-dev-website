...
export default function GrpcServiceHeaders() {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>Simple RPC service - Send/Receive headers</h1>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.0/examples/grpc-service-headers",
                "_blank"
              );
            }}
