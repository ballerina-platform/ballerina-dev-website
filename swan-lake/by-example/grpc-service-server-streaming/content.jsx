...
export default function GrpcServiceServerStreaming() {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>gRPC service - Server streaming RPC</h1>
      ...
      <ul style={{ marginLeft: "0px" }}>
        <li>
          ...
          <span>
            ...
            <code>grpc_server_streaming.proto</code> and add service definition
            below.
          </span>
        </li>
      </ul>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.0/examples/grpc-service-server-streaming",
                "_blank"
              );
            }}
      ...
      <p>
        Once you run the command, the <code>grpc_server_streaming_pb.bal</code>{" "}
      ...
      <ul style={{ marginLeft: "0px" }}>
        <li>
          <span>2.</span>
          <span>
            Copy the generated <code>grpc_server_streaming_pb.bal</code> file
      ...
      <ul style={{ marginLeft: "0px" }}>
        <li>
          <span>3.</span>
          <span>
            Create a new <code>grpc_server_streaming.bal</code> file inside the{" "}
      ...
      <blockquote>
        <p>
          ...
          <a href="/learn/by-example/grpc-client-server-streaming/">
