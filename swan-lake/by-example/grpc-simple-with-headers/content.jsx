  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <ul style={{ marginLeft: "0px" }}>
        <li>
          ...
          <span>
            ...
            <code>grpc_simple_with_headers.proto</code> and add the service
            definition.
          </span>
        </li>
      </ul>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.3/examples/grpc-simple-with-headers",
                "_blank"
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal grpc --input grpc_simple_with_headers.proto  --output stubs`}</span>
            </code>
          </pre>
        </Col>
      </Row>
      ...
      <p>
        ...
        <code>grpc_simple_with_headers_pb.bal</code> file is generated inside
        the <code>stubs</code> directory.
      </p>
      ...
      <ul style={{ marginLeft: "0px" }}>
        <li>
          <span>2.</span>
          <span>
            Copy the generated <code>grpc_simple_with_headers_pb.bal</code> stub
      ...
      <ul style={{ marginLeft: "0px" }}>
        <li>
          <span>3.</span>
          <span>
            Create a new <code>grpc_simple_with_headers.bal</code> Ballerina
...
`}</span>
      ...
      <ul style={{ marginLeft: "0px" }}>
        <li>
          <span>3.</span>
          <span>
            Create a new <code>grpc_simple_with_headers_client.bal</code>{" "}
