      ...
      <Row className="bbeCode px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
        ...
        <Col className="d-flex align-items-start pt-2" sm={2}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.0.3/grpc-simple-with-headers",
                "_blank"
              );
            }}
        ...
        <pre className="m-0">
          <code className="d-flex flex-column">
            <span>
              ...
              <code>{`grpc_simple_with_headers.proto`}</code>
              {` and add the service definition.`}
            </span>
            <span>{`# Run the command below in the Ballerina tools distribution for stub generation.`}</span>
            <span>
              {``}
              <code>{`bal grpc --input grpc_simple_with_headers.proto  --output stubs`}</code>
              {``}
            </span>
            <span>{``}</span>
            <span>
              {`# Once you run the command, the `}
              <code>{`grpc_simple_with_headers_pb.bal`}</code>
              {` file is generated inside the `}
              <code>{`stubs`}</code>
              {` directory.`}
            </span>
            <span>{``}</span>
      ...
      <Row className="bbeOutput p-2 rounded">
        <pre className="m-0">
          <code className="d-flex flex-column">
            ...
            <span>
              {`# Create a new `}
              <code>{`grpc_simple_with_headers.bal`}</code>
            ...
            <span>
              {``}
              <code>{`bal run service/target/bin/service.jar`}</code>
              {``}
            </span>
          </code>
        </pre>
      ...
      <Row className="bbeOutput p-2 rounded">
        <pre className="m-0">
          <code className="d-flex flex-column">
            ...
            <span>
              {`# Create a new `}
              <code>{`grpc_simple_with_headers_client.bal`}</code>
              {` Ballerina file inside the `}
              <code>{`client`}</code>
            ...
            <span>
              {``}
              <code>{`bal run client/target/bin/client.jar`}</code>
              {``}
            </span>
          </code>
        </pre>
