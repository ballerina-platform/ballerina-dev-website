...
service / on new http:Listener(9090, httpVersion = "1.1") {
    ...
    resource method 'default http11Service(http:Request clientRequest)
            returns json|error {
...
service / on new http:Listener(7090) {
    ...
    resource method 'default http2service() returns json {
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.3/examples/http-1-1-to-2-0-protocol-switch",
                "_blank"
              );
            }}
