...
export default function Http100Continue() {
  ...
  return (
    <Container className="d-flex flex-column h-100">
      ...
      <p>
        100-continue indicates that the server has received the request headers
        and the client can proceed with sending the
        request.&lt;br/&gt;&lt;br/&gt;
      </p>
      ...
      <Row className="bbeCode px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
        ...
        <Col className="d-flex align-items-start pt-2" sm={2}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.0.3/http-100-continue",
                "_blank"
              );
            }}
