...
export function Http20ClientServerPush({codeSnippets}) {
...
<p>HTTP/2 server push messages can be received using the Ballerina <code>http:Client</code>. HTTP/2 Server Push messages allow the server to send resources to the client before the client requests them.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/http-2-0-client-server-push", "_blank");
      }}
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span>Run the HTTP service given in the <a href="/learn/by-example/http-2-0-server-push/">HTTP/2 server push</a> example.</span>
                        </li>
                    </ul>
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run http_2_0_client_server_push.bal`}</span>
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="https://lib.ballerina.io/ballerina/http/latest#Client#hasPromise"><code>hasPromise()</code> - API documentation</a></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} class="relatedLinks">
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="https://lib.ballerina.io/ballerina/http/latest#Client#getNextPromise"><code>getNextPromise()</code> - API documentation</a></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} class="relatedLinks">
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="https://lib.ballerina.io/ballerina/http/latest#Client#rejectPromise"><code>rejectPromise()</code> - API documentation</a></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} class="relatedLinks">
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="/spec/http/#1011-push-promise-and-promise-response">Push promise and promise response - Specification</a></span>
                        </li>
