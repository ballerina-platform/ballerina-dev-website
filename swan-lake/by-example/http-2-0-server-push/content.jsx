...
<p>HTTP/2 server push messages can be sent using the Ballerina <code>http</code> service. HTTP/2 server push messages allow the server to send resources to the client before the client requests them.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/http-2-0-server-push", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run http_2_0_server_push.bal`}</span>
</code></pre>
          </Col>
        </Row>

<blockquote>
<p><strong>Tip:</strong> You can invoke the above service via the <a href="/learn/by-example/http-2-0-client-server-push/">Server push client</a> example.</p>
</blockquote>
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="https://lib.ballerina.io/ballerina/http/latest#Caller#promise"><code>promise()</code> - API documentation</a></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} class="relatedLinks">
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="https://lib.ballerina.io/ballerina/http/latest#Caller#pushPromisedResponse"><code>pushPromisedResponse()</code> - API documentation</a></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} class="relatedLinks">
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="/spec/http/#1011-push-promise-and-promise-response">HTTP service Server push - Specification</a></span>
                        </li>
