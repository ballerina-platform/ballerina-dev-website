...
export function Http2PriorKnowledgeClient({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        The HTTP client is configured to enable HTTP/2 prior knowledge. So the
        client will directly send requests using HTTP/2 without an HTTP/2
        upgrade request.
      </p>
        ...
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
<<<<<<< HEAD
                "https://play.ballerina.io/?gist=4b9fd30eeb5334aa1651e2e639b4745c&file=http_2_prior_knowledge_client.bal",
=======
                "https://play.ballerina.io/?gist=dace83cc07952322cc00f553deb3bff4&file=http_2_prior_knowledge_client.bal",
>>>>>>> 4544b7b84e3fbafce0347071b7db377f1be8adda
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.7.0/examples/http-2-prior-knowledge-client",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run http_2_prior_knowledge_client.bal`}</span>
