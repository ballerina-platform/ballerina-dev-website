      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=12d5c21bfe2e546322cc0185f7fc35ee&file=http_access_logs.bal",
                "_blank"
              );
            }}
            target="_blank"
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=88727ee2ea8100940492c60690b40c0b&file=Config.toml",
                "_blank"
              );
            }}
            target="_blank"
