...
export default function HttpBasicRestService() {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        Ballerina supports writing RESTful services with its first-class service
        and resource concepts. The <code>accessor-name</code>,{" "}
        <code>service/resource name</code>, <code>data binding</code>,{" "}
        <code>path</code>, and <code>query</code> parameter support help to
        write meaningful APIs. The sample depicts the way of writing the{" "}
