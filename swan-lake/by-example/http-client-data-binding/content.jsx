...
service /call on new http:Listener(9090) {
    ...
    resource method get all() returns json|error {
    ...
    // When the data binding is expected to happen and if the \`post\` remote method gets a 5XX response from the
    ...
    resource method get '5xx() returns json {
    ...
    // When the data binding is expected to happen and if the client remote method gets a 4XX response from the
    ...
    resource method get '4xx() returns json {
...
service /backend on new http:Listener(9092) {
    ...
    resource method get 'string() returns string {
        return "Hello ballerina!!!!";
    }

    resource method get person() returns record {|*http:Ok; Person body;|} {
        return {body: {name: "Smith", age: 15}};
    }

    resource method post '5XX() returns http:NotImplemented {
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.3/examples/http-client-data-binding",
                "_blank"
              );
            }}
