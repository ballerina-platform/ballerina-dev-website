      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=4a42c21b28aac62318947315dc8a8c50&file=http_client_header_parameter.bal",
                "_blank"
              );
            }}
            target="_blank"
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=1dc41e4cf9f6853966afb2be7d541374&file=http_client_header_parameter_post.bal",
                "_blank"
              );
            }}
            target="_blank"
