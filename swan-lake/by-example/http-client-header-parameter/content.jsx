      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=b3c6cedcaca5dd06b09134278cfdec47&file=http_client_header_parameter.bal",
                "_blank"
              );
            }}
            target="_blank"
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=894e67ed166814baafd1284aecc2575a&file=http_client_header_parameter_post.bal",
                "_blank"
              );
            }}
            target="_blank"
