      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=8ce5bfbf9ba20a46d5b184c869990e76&file=http_client_header_parameter.bal",
                "_blank"
              );
            }}
            target="_blank"
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=b0db34167d2dab985e57ce4907ff824b&file=http_client_header_parameter_post.bal",
                "_blank"
              );
            }}
            target="_blank"
