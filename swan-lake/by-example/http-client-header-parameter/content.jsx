      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=11c98f8a0ab1f3d14295674855eed14f&file=http_client_header_parameter.bal",
                "_blank",
              );
            }}
            target="_blank"
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=989abc2790aa4710ad0e3149ad798421&file=http_client_header_parameter_post.bal",
                "_blank",
              );
            }}
            target="_blank"
