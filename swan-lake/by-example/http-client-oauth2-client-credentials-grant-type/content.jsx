...
export default function HttpClientOauth2ClientCredentialsGrantType() {
  ...
  return (
    <Container className="d-flex flex-column h-100">
      ...
      <p>
        passing the <code>http:OAuth2ClientCredentialsGrantConfig</code> for the{" "}
        <code>auth</code>
      </p>
      ...
      <Row className="bbeCode px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
        ...
        <Col className="d-flex align-items-start pt-2" sm={2}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.0.3/http-client-oauth2-client-credentials-grant-type",
                "_blank"
              );
            }}
