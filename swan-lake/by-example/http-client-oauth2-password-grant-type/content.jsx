...
export default function HttpClientOauth2PasswordGrantType() {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        passing the <code>http:OAuth2PasswordGrantConfig</code> to the{" "}
      ...
      <Row className="bbeCode mx-0 py-0 rounded" style={{ marginLeft: "0px" }}>
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.1/examples/http-client-oauth2-password-grant-type",
                "_blank"
              );
            }}
