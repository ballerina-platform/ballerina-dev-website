      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=984535524f54974cb49ba57d5d483933&file=http_client_oauth2_refresh_token_grant_type.bal",
                "_blank"
              );
            }}
            target="_blank"
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.3.2/examples/http-client-oauth2-refresh-token-grant-type",
                "_blank"
              );
            }}
