  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        ...
        with the OAuth2 refresh token grant type by adding the{" "}
        ...
        <code>auth</code> field of the client configuration. Use this to
        automatically retrieve an access token when it is expired.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "vscode://wso2.ballerina/open-file?repoFileUrl=https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.8.2/examples/http-client-oauth2-refresh-token-grant-type/http_client_oauth2_refresh_token_grant_type.md",
                "_blank",
              );
            }}
            target="_blank"
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.8.2/examples/http-client-oauth2-refresh-token-grant-type",
                "_blank",
              );
            }}
