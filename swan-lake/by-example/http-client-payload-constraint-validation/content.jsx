...
export default function HttpClientPayloadConstraintValidation() {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        ...
        fails, an <code>http:PayloadValidationError</code> will be returned with
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.0/examples/http-client-payload-constraint-validation",
                "_blank"
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              ...
              <span>{`Validation failed: payload validation failed: Validation failed for '\$.title:maxLength' constraint(s).`}</span>
            </code>
          </pre>
        </Col>
      </Row>
