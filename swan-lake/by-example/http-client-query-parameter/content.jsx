      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=3d3401ea8a1eb3ed3f81d49641813cb4&file=http_client_query_parameter.bal",
                "_blank",
              );
            }}
            target="_blank"
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.8.0/examples/http-client-query-parameter",
                "_blank",
              );
            }}
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=b231bf666d799e7d024979af5b90eb66&file=http_client_query_parameter_post.bal",
                "_blank",
              );
            }}
            target="_blank"
