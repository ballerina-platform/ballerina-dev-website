...
export default function HttpClientQueryParameter() {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        ...
        aforementioned types. The query param type can be nil as well.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.0/examples/http-client-query-parameter",
                "_blank"
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              ...
              <span>{`Received albums: [{"title":"Blue Train", "artist":"John Coltrane", "year":1958}]`}</span>
            </code>
          </pre>
        </Col>
      </Row>
