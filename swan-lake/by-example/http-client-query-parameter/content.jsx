      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=1f33a9f5361a39b8b931f10094b0dfdd&file=http_client_query_parameter.bal",
                "_blank"
              );
            }}
            target="_blank"
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=18eea50b606f79e24be8ffd9ffba0c41&file=http_client_query_parameter_post.bal",
                "_blank"
              );
            }}
            target="_blank"
