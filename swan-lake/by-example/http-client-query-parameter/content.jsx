      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=39d21647281eacd4b76506f123fe6297&file=http_client_query_parameter.bal",
                "_blank"
              );
            }}
            target="_blank"
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=0d6b0c6c9067603d2a9db6e50c63e79f&file=http_client_query_parameter_post.bal",
                "_blank"
              );
            }}
            target="_blank"
