      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=d97682e647ffe2cc6b87f245a97c362c&file=http_client_query_parameter.bal",
                "_blank",
              );
            }}
            target="_blank"
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=0a74198fc1f2a951664cc521eab9b0b3&file=http_client_query_parameter_post.bal",
                "_blank",
              );
            }}
            target="_blank"
