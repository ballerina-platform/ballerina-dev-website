...
<p>HTTP cookies can track, personalize, and manage the session in the service. The cookies can be accessed from the <code>getCookies</code> method of the <code>http:Request</code>. Setting cookies back in the response is done by the <code>addCookie</code> method of the <code>http:Response</code>. This is useful for services to maintain the state.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/http-cookies-service", "_blank");
      }}
...
<blockquote>
<p><strong>Tip:</strong> You can invoke the above service via the <a href="/learn/by-example/http-cookies-client/">Cookies client</a> example.</p>
</blockquote>
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="https://lib.ballerina.io/ballerina/http/latest#Cookie"><code>http:Cookie</code> - API documentation</a></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} class="relatedLinks">
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="/spec/http/#2416-cookie">HTTP service cookie - Specification</a></span>
                        </li>
