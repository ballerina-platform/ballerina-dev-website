...
export default function HttpCookies() {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.1/examples/http-cookies",
                "_blank"
              );
            }}
      ...
      <p>Invoke the service by executing the following main program.</p>
      ...
      <p>Run the main program as follows.</p>
