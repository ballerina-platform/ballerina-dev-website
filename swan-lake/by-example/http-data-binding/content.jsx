...
service /hello on new http:Listener(9090) {
    ...
    resource method post student(@http:Payload Student student) returns json {
        string name = student.Name;
        return {Name: name};
    }

    //Binds the XML payload of the inbound request to the \`store\` variable.
    resource method post store(@http:Payload xml store) returns xml {
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.3/examples/http-data-binding",
                "_blank"
              );
            }}
