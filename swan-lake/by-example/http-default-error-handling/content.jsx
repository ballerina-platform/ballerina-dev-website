...
export default function HttpDefaultErrorHandling({codeSnippets}) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        ...
        ways to propagate errors, the most common way is to use the check
        keyword. <code>http:Listener</code> intercepts these errors and sends a{" "}
        <code>500 Internal Server Error</code> response with the error message
        in the payload. In addition, it logs the error with the stack trace in
        the console. Users can take control of this behavior by adding a{" "}
        <code>do/fail</code> block in the resource method and handling the
        errors themselves. When there is a repetition of error handling logic in
        the resource method, the repetition can be avoided by moving the logic
        to an Error handler interceptor.
      </p>
