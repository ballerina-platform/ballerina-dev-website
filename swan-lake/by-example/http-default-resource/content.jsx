...
service on new http:Listener(9090) {
    ...
    resource method 'default [string... paths](http:Request req) returns json {
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.3/examples/http-default-resource",
                "_blank"
              );
            }}
