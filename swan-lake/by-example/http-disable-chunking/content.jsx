...
service / on new http:Listener(9092) {
    resource method get chunkingSample() returns json|error {
...
service / on new http:Listener(9090) {
    resource method post echo(@http:Header{name:"Content-length"} string cLen) returns json {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.3/examples/http-disable-chunking",
                "_blank"
              );
            }}
      ...
      <Row className="mt-auto mb-5">
        <Col sm={6}>
          <Link title="Cookies" href="/learn/by-example/http-cookies">
