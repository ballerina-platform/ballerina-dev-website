...
// service can only have one remote method: \`interceptResponseError\`.
service class ResponseErrorInterceptor {
    *http:ResponseErrorInterceptor;
    ...
    remote method interceptResponseError(error err) returns http:InternalServerError {
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.3/examples/http-error-handling",
                "_blank"
              );
            }}
