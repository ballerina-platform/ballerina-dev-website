...
service / on new http:Listener(9090) {
    ...
    resource method get hello(@http:Header {name: "X-Client-Key"} string clientKey)
            returns string {
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.3/examples/http-header-param",
                "_blank"
              );
            }}
