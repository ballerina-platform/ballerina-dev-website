...
service /company on new http:Listener(9090) {
    ...
    // request URI.
    resource method get empId/[int id]() returns json {
        return {empId: id};
    }

    resource method get empName/[string first]/[string last]() returns json {
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.3/examples/http-path-param",
                "_blank"
              );
            }}
