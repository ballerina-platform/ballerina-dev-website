...
service /product on new http:Listener(9090) {
    ...
    resource method get count(int a, int b) returns json {
        return { count : a + b};
    }
    ...
    resource method get name(string? id) returns string {
        if id is string {
            return "product_" + id;
        }
        return "product_0000";
    ...
    resource method get detail(string[]? colour) returns json {
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.3/examples/http-query-parameter",
                "_blank"
              );
            }}
