  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        ...
        URL query parameters as resource method arguments. The supported types
        are <code>string</code>, <code>int</code>, <code>float</code>,{" "}
        <code>boolean</code>, <code>decimal</code>, and <code>array types</code>{" "}
        of the aforementioned types. The query param type can be nilable (e.g.,{" "}
        <code>string? bar</code>). The request also provides a certain method to
        retrieve query param at their convenience.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.3.0/examples/http-query-parameter",
                "_blank"
              );
            }}
