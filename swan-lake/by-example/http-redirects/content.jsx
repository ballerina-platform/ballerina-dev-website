...
service / on new http:Listener(9090) {
    ...
    resource method get hello() returns string|error {
...
service / on new http:Listener(9092) {
    ...
    resource method get redirect1(http:Caller caller) returns error? {
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.3/examples/http-redirects",
                "_blank"
              );
            }}
