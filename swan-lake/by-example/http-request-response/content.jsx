  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        ...
        Ballerina abstractions for HTTP request and HTTP response respectively.
        They are considered low-level abstractions which are used to implement
        high-level abstractions such as data-binding, header mapping, query
        parameter mapping, etc. They can be used both on the client side and the
        service side. They are useful when implementing advanced scenarios such
        as gateways, proxy services, handling multipart requests, etc. In most
        cases, the <code>http:Request</code> and the <code>http:Response</code>{" "}
        objects are not needed as higher-level abstractions can do the same
        thing.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "vscode://wso2.ballerina/open-file?repoFileUrl=https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.8.3/examples/http-request-response/http_request_response.md",
                "_blank",
              );
            }}
            target="_blank"
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.8.3/examples/http-request-response",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run http_request_response.bal`}</span>
            </code>
          </pre>
        </Col>
      </Row>
      ...
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
        <li>
          <span>&#8226;&nbsp;</span>
          <span>
            <a href="/spec/http/#6-request-and-response">
              HTTP request and response - Specification
            </a>
          </span>
        </li>
      </ul>
