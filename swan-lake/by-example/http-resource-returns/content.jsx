...
service /bank on new http:Listener(9090) {
    ...
    resource method get branch() returns @http:Payload {mediaType:"application/json+id"} json {
    ...
    resource method get [string 'type]()
    ...
    resource method put account(@http:Payload string name)
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.3/examples/http-resource-returns",
                "_blank"
              );
            }}
