...
<p>The multipart payload is one or more different sets of data combined in a single body. HTTP service supports multipart content setting and retrieving in the <code>http:Response</code> along with the nested parts through support functions. An array of <code>mime:Entity</code> is returned when retrieving parts through <code>getBodyParts</code> method of the <code>http:Response</code>. If the received parts contain nested parts, you can loop through the parent parts and get the child parts. When sending out multipart content, <code>setBodyParts</code> is used to set the array of <code>mime:Entity</code>. This is useful to handle different content-typed messages as a single payload and large payloads.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/http-response-with-multiparts", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run response_with_multiparts.bal`}</span>
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref2}>
      <code className="d-flex flex-column"><span>{`\$ curl http://localhost:9092/multiparts/encoder`}</span>
...
<p>To decode the inbound response with multiparts, execute the following cURL command.</p>
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref3}>
      <code className="d-flex flex-column"><span>{`\$ curl http://localhost:9090/multiparts/decoder`}</span>
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="https://lib.ballerina.io/ballerina/mime/latest#Entity#setBodyParts"><code>setBodyParts()</code> - API documentation</a></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} class="relatedLinks">
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="/spec/mime/#3-supported-multipart-types">HTTP service supported-multipart-types - Specification</a></span>
                        </li>
