  ...
  return (
    <Container className="d-flex flex-column h-100">
      ...
      <p>
        ...
        media they consume and produce.
      </p>

      <p>
        This is done through the <code>consumes</code> and <code>produces</code>{" "}
        annotation attributes of the <code>ResourceConfig</code> annotation,
      </p>
      ...
      <Row className="bbeCode px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
        ...
        <Col className="d-flex align-items-start pt-2" sm={2}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.0.3/http-restrict-by-media-type",
                "_blank"
              );
            }}
      ...
      <Row className="bbeOutput p-2 rounded">
        <pre className="m-0">
          <code className="d-flex flex-column">
            <span>{`# To invoke the service, execute the following cURL request.`}</span>
            ...
            <span>
              {`# in the Accept header is not listed under the `}
              <code>{`produces`}</code>
              {` resource configuration.`}
            </span>
