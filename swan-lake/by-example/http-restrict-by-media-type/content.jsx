...
<p>The content negotiation for the REST API design is achieved via the <code>consumes</code> and <code>produces</code> configurations. The resource accepting request content type is defined under the <code>consumes</code> and the resource producing response content type is defined under the <code>produces</code> in the resource configuration. Each configuration is checked against the <code>Accept</code> header and the <code>Content-type</code> header of the request. If the negotiation fails, the error response is returned with <code>406 Not Acceptable</code> or <code>415 Unsupported</code> status codes respectively.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/http-restrict-by-media-type", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref2}>
      <code className="d-flex flex-column"><span>{`\$ curl -v http://localhost:9090/transform -H "Accept:application/xml" -H "Content-Type:text/plain" -d 'Ballerina'`}</span>
<span>{`*   Trying ::1...`}</span>
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="https://lib.ballerina.io/ballerina/http/latest#HttpResourceConfig"><code>http:ResourceConfig</code> - API documentation</a></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} class="relatedLinks">
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="/spec/http/#42-resource-configuration">HTTP service resource configuration - Specification</a></span>
                        </li>
