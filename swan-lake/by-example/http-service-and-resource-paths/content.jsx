...
export function HttpServiceAndResourcePaths({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        The <code>service path</code> is defined in the service declaration and
        the <code>resource path</code> is defined in the resource method
        definition. Each resource can be invoked by using the{" "}
        <code>service path</code>, <code>resource path</code>, and{" "}
        <code>resource accessor</code>. In an HTTP resource, the{" "}
        <code>resource accessor</code> confines the resource to a specific HTTP
        method.
      </p>
        ...
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
<<<<<<< HEAD
                "https://play.ballerina.io/?gist=02a89ff1c9cd55364c8a6452e8419a3e&file=http_service_and_resource_paths.bal",
=======
                "https://play.ballerina.io/?gist=336f1894b3d76c9b4c1db1a3fc9cdd3f&file=http_service_and_resource_paths.bal",
>>>>>>> 4544b7b84e3fbafce0347071b7db377f1be8adda
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.7.0/examples/http-service-and-resource-paths",
                "_blank",
              );
            }}
