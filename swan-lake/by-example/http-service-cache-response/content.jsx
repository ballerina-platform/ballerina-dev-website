...
export default function HttpServiceCacheResponse() {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>HTTP service - Sending cache response</h1>

      <p>
        HTTP service can send cache response by population cache controls in the
        response.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.0/examples/http-service-cache-response",
                "_blank"
              );
            }}
