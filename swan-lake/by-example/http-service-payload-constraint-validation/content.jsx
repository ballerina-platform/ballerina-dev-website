        ...
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
<<<<<<< HEAD
                "https://play.ballerina.io/?gist=2caf6d5220d162987080cb5804bb424a&file=http_service_payload_constraint_validation.bal",
=======
                "https://play.ballerina.io/?gist=142ac02260d2f36733dc6e03caf662c2&file=http_service_payload_constraint_validation.bal",
>>>>>>> 4544b7b84e3fbafce0347071b7db377f1be8adda
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.7.0/examples/http-service-payload-constraint-validation",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run http_service_payload_constraint_validation.bal`}</span>
            </code>
          </pre>
        </Col>
      </Row>
