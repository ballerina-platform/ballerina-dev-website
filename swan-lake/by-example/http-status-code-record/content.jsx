...
export default function HttpStatusCodeRecord() {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        ...
        that contains response headers and payload. Ballerina
      </p>

      <p>
        provides build in records for each HTTP status codes. In addition to
        that, record constants are also available in
      </p>

      <p>any modification is not needed for the default data.</p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.0/examples/http-status-code-record",
                "_blank"
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run http_status_code_record.bal`}</span>
            </code>
          </pre>
        </Col>
      </Row>
        ...
        <Col sm={12}>
          <pre ref={ref2}>
            <code className="d-flex flex-column">
              ...
              <span>{`<`}</span>
              <span>{`{"message":"album is already exist"}`}</span>
            </code>
          </pre>
        </Col>
      </Row>
