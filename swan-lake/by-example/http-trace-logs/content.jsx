  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        ...
        <code>-Cballerina.http.traceLogConsole=true</code> runtime argument. The
        configurations can be set in the <code>Config.toml</code> file for
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.3.0/examples/http-trace-logs",
                "_blank"
              );
            }}
