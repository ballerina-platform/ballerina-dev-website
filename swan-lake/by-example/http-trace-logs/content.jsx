...
<p>Ballerina allows enabling HTTP trace logs, which can be used to monitor the HTTP traffic that goes in and out of the application. HTTP trace logs are disabled by default. Set the log level to <code>TRACE</code> using the <code>-Cballerina.http.traceLogConsole=true</code> runtime argument to enable them.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/http-trace-logs", "_blank");
      }}
...
<p>Run the service as follows with the runtime argument to enable trace logs.</p>
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref2}>
      <code className="d-flex flex-column"><span>{`\$ curl http://localhost:9095/info/albums`}</span>
<span>{`[{"title":"Blue Train", "artist":"John Coltrane"}, {"title":"Jeru", "artist":"Gerry Mulligan"}]`}</span>
</code></pre>
          </Col>
        </Row>

<p>Additionally, the following configurations can be added to the <code>Config.toml</code> file for advanced use cases such as specifying the file path to save the trace logs to a file and the hostname and port of a socket service to publish the trace logs.</p>
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="https://lib.ballerina.io/ballerina/http/latest#TraceLogAdvancedConfiguration"><code>http:TraceLogAdvancedConfiguration</code> record</a></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} class="relatedLinks">
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="/spec/http/#823-trace-log">HTTP service trace log - Specification</a></span>
                        </li>
