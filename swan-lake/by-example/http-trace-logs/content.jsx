      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=791411070b96504fde582255dff6bdfd&file=http_trace_logs.bal",
                "_blank"
              );
            }}
            target="_blank"
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=1cc6be024b73bfc5b9f96630f80bc3fe&file=Config.toml",
                "_blank"
              );
            }}
            target="_blank"
