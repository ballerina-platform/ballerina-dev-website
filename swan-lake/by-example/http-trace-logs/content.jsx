      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=c32a8918c1300d719a818400953a73dd&file=http_trace_logs.bal",
                "_blank"
              );
            }}
            target="_blank"
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=290c47b905240f8b34e61c380359c44e&file=Config.toml",
                "_blank"
              );
            }}
            target="_blank"
