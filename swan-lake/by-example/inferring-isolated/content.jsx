...
<p><code>isolated</code> is a complex feature, which would be a lot for an application developer to understand. A typical Ballerina application consists of a single module that imports multiple library modules. Within a single module, the compiler infers <code>isolated</code> qualifiers. An object without mutable fields is inherently <code>isolated</code>. It is the application developer's responsibility to use <code>lock</code> statements where needed. E.g.,</p>
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span>accessing <code>self</code> in a <code>service</code> object with mutable state</span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} >
...
<p>Compiler can inform developer where missing locks are preventing a <code>service</code> object or method from being <code>isolated</code>.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/inferring-isolated", "_blank");
      }}
