...
export function InitReturnType({codeSnippets}) {
...
<p><code>init</code> function has a return type, which must be a subtype of <code>error?</code>. If <code>init</code> returns <code>()</code>, then, <code>new</code> returns the newly constructed <code>object</code>. If <code>init</code> returns an <code>error</code>, then <code>new</code> returns that <code>error</code>. If <code>init</code> does not specify a return type, then the return type defaults to <code>()</code> as usual, meaning that <code>new</code> will never return an <code>error</code>.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/init-return-type", "_blank");
      }}
