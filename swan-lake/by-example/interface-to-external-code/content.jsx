  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        ...
        using the <code>external</code> keyword, instead of implementing the
        function body. The implementation figures out how to map to the external
        implementation. As part of interfacing to an external implementation,
        Ballerina supports another basic type called <code>handle</code>. The{" "}
        <code>handle</code> type is basically an opaque handle that can be
        passed to and from external functions. There is no typing for{" "}
        <code>handle</code> and it can be added as a private member of a
        Ballerina class for better type safety.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "vscode://wso2.ballerina/open-file?repoFileUrl=https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.8.2/examples/interface-to-external-code/interface_to_external_code.md",
                "_blank",
              );
            }}
            target="_blank"
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.8.2/examples/interface-to-external-code",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run interface_to_external_code.bal`}</span>
