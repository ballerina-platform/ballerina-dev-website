...
export function IoBytes({codeSnippets}) {
...
<p>The Ballerina <code>io</code> library contains APIs to read/write bytes from/to a file.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/io-bytes", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`# In the directory, which contains the \`.bal\` file, create a directory named \`files\`,`}</span>
