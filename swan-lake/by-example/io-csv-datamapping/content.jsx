...
export default function IoCsvDatamapping() {
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=d31b9568e974a501661cce0ac074c3ae&file=io_csv_datamapping.bal",
                "_blank"
              );
            }}
            target="_blank"
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.2/examples/io-csv-datamapping",
                "_blank"
              );
            }}
