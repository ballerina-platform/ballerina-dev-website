...
export function IterativeUseOfTypedBinding({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        The iterative use is always followed by the <code>in</code> keyword. In
        this approach, an iterator gets created as a result of evaluating an
        expression, and the typed binding pattern is matched against each value
        returned by the iterator. The <code>in</code> keyword can be used with
        the <code>foreach</code> statement, <code>from</code> clause, and{" "}
        <code>join</code> clause in query expressions, and with the{" "}
        ...
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
<<<<<<< HEAD
                "https://play.ballerina.io/?gist=5d7b92c5390af14dc9a6ef002a70352a&file=iterative_use_of_typed_binding.bal",
=======
                "https://play.ballerina.io/?gist=353299627df9df70e585542867abdd89&file=iterative_use_of_typed_binding.bal",
>>>>>>> 4544b7b84e3fbafce0347071b7db377f1be8adda
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.7.0/examples/iterative-use-of-typed-binding",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run iterative_use_of_typed_binding.bal`}</span>
