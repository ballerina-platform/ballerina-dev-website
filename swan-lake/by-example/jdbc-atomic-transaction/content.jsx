...
export default function JdbcAtomicTransaction() {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>JDBC client - Atomic transactions</h1>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.0/examples/jdbc-atomic-transaction",
                "_blank"
              );
            }}
...
`}</span>
              ...
              <span>{`time = 2022-06-22T13:55:32.038+05:30 level = INFO module = "" message = "One of the queries failed. Rollback transaction."`}</span>
            </code>
          </pre>
        </Col>
      </Row>
