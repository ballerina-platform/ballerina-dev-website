  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        ...
        operations. Note that the relevant database driver JAR should be defined
        in the <code>Ballerina.toml</code> file as a dependency.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.3.0/examples/jdbc-execute-operation",
                "_blank"
              );
            }}
