...
export function JmsConsumerAcknowledgement({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        ...
        received messages. A <code>jms:MessageConsumer</code> can be initialized
        by using a <code>jms:Session</code> object. To configure manual
        acknowledgment mode, create a <code>jms:Session</code> object with the
        acknowledge mode set to <code>jms:CLIENT_ACKNOWLEDGE</code>.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/jms-consumer-acknowledgement",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run jms_consumer_acknowledgement.bal`}</span>
            </code>
          </pre>
        </Col>
      </Row>
      ...
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
        <li>
          <span>&#8226;&nbsp;</span>
          <span>
            <a href="https://lib.ballerina.io/ballerinax/java.jms/latest#MessageConsumer-acknowledge">
              <code>jms:MessageConsumer-&gt;acknowledge</code> function - API
              documentation
            </a>
          </span>
        </li>
