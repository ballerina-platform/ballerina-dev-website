        ...
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
<<<<<<< HEAD
                "https://play.ballerina.io/?gist=dafcbf5f0e8bb48fe27e618687917b96&file=joining_iterable_objects.bal",
=======
                "https://play.ballerina.io/?gist=424a5cc8ce582c06256a2e5a14e57277&file=joining_iterable_objects.bal",
>>>>>>> 4544b7b84e3fbafce0347071b7db377f1be8adda
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.7.0/examples/joining-iterable-objects",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run joining_iterable_objects.bal`}</span>
