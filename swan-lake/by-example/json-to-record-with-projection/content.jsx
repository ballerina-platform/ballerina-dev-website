...
export function JsonToRecordWithProjection({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>JSON to record conversion with projection</h1>

      <p>
        The <code>data.jsondata</code> library provides multiple APIs to
        selectively convert required fields from JSON data in the form of a{" "}
        <code>string</code>, <code>byte[]</code>, <code>byte-block-stream</code>
        , and <code>json</code> to a Ballerina record.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/json-to-record-with-projection",
                "_blank",
              );
            }}
