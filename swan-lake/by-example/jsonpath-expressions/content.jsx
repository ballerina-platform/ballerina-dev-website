...
export function JsonpathExpressions({ codeSnippets }) {
    ...
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        ...
        <a href="https://lib.ballerina.io/ballerina/data.jsondata/latest/">
          <code>ballerina/data.jsondata</code> module
        </a>{" "}
        module to provide a straightforward method
      </p>

      <p>for navigating the structure of JSON data.</p>

      <p>
        Alternatively, Ballerina supports type based access to JSON data by
        language itself.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/jsonpath-expressions",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run jsonpath_expressions.bal`}</span>
              <span>{`["The Great Gatsby","To Kill a Mockingbird","1984"]`}</span>
              <span>{`[1925,1949]`}</span>
              <span>{`262.5`}</span>
            </code>
          </pre>
