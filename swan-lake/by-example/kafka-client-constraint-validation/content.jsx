  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        ...
        constraints added to the payload record. When a payload fails to
        validate, <code>seek</code> api of <code>kafka:Consumer</code> can be
        used to seek past the erroneous record and read new records.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.0/examples/kafka-client-constraint-validation",
                "_blank"
              );
            }}
      ...
      <ul style={{ marginLeft: "0px" }}>
        <li>
          ...
          <span>
            ...
            example with a valid product name (0 &lt; length &lt;= 30), then
            with an invalid product name and again with a valid product name.
          </span>
        </li>
      </ul>
