...
export function KafkaClientConstraintValidation({ codeSnippets }) {
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.3.1/examples/kafka-client-constraint-validation",
                "_blank"
              );
            }}
