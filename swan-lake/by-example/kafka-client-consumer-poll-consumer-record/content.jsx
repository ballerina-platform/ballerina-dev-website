...
export default function KafkaClientConsumerPollConsumerRecord() {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>Kafka consumer - Poll ConsumerRecord</h1>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.0/examples/kafka-client-consumer-poll-consumer-record",
                "_blank"
              );
            }}
      ...
      <Row className="mt-auto mb-5">
        <Col sm={6}>
          <Link
            title="Consumer - Poll Payload"
            href="/learn/by-example/kafka-client-consumer-poll-payload"
          >
