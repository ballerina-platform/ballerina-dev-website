...
export default function KafkaClientConsumerPollPayload() {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>Kafka consumer - Poll payload</h1>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.0/examples/kafka-client-consumer-poll-payload",
                "_blank"
              );
            }}
