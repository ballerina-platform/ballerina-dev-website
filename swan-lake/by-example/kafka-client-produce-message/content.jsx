...
export default function KafkaClientProduceMessage() {
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.0/examples/kafka-client-produce-message",
                "_blank"
              );
            }}
