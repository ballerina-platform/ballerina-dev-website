...
export default function KafkaProducerTransactional() {
  ...
  return (
    <Container className="d-flex flex-column h-100">
      ...
      <p>
        messages to Kafka brokers atomically using the{" "}
        <code>kafka:Producer</code> client. For
      </p>
      ...
      <Row className="bbeCode px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
        ...
        <Col className="d-flex align-items-start pt-2" sm={2}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.0.3/kafka-producer-transactional",
                "_blank"
              );
            }}
