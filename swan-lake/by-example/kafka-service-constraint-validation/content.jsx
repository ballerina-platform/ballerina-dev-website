...
export default function KafkaServiceConstraintValidation() {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        ...
        validate, <code>seek</code> api of <code>kafka:Caller</code> can be used
        to seek past the erroneous record and read new records.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.0/examples/kafka-service-constraint-validation",
                "_blank"
              );
            }}
