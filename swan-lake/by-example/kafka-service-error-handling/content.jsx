      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/kafka-service-error-handling",
                "_blank",
              );
            }}
        ...
        <li>
          ...
          <span>
            <a href="https://lib.ballerina.io/ballerinax/kafka/latest">
              <code>kafka</code> module - API documentation
            </a>
          </span>
        </li>
      </ul>
