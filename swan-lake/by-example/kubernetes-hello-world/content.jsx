...
export function KubernetesHelloWorld({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        Ballerina supports generating Kubernetes artifacts from code without any
        additional configuration. This simplifies the experience of developing
        and deploying Ballerina code in the cloud. Code to Cloud builds the
        containers and required artifacts by deriving the required values from
        the code. If you want to override the default values taken by the
        compiler, you can use a <code>Cloud.toml</code> file.
      </p>

      <p>
        For more information, see{" "}
        <a href="/learn/code-to-cloud-deployment/">Code to Cloud deployment</a>.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/kubernetes-hello-world",
                "_blank",
              );
            }}
      ...
      <p>
        Before you build the package, you need to override some default values
        taken by the compiler. To do this, create a filed named{" "}
        <code>Cloud.toml</code> in the package directory, and add the content
        below to it.
      </p>

      <p>
        For all the supported key value properties, see{" "}
        <a href="https://github.com/ballerina-platform/ballerina-spec/blob/master/c2c/code-to-cloud-spec.md">
          Code to Cloud Specification
        </a>
        .
      </p>
...
`}</span>
      ...
      >
        ...
        <Col sm={12}>
          <pre ref={ref2}>
            <code className="d-flex flex-column">
              <span>{`\$ docker push wso2inc/hello:v0.1.0`}</span>
            </code>
          </pre>
        </Col>
      </Row>
      ...
      <p>
        If the External IP of the <code>hello-svc-local</code> service is{" "}
        <code>&lt;none&gt;</code>, you need to follow cluster-specific steps to
        obtain the external IP. If you are using Minikube, you can use the{" "}
        <code>minikube ip</code> command to obtain the IP.
      </p>
      ...
      >
        ...
        <Col sm={12}>
          <pre ref={ref8}>
            <code className="d-flex flex-column">
              <span>{`\$ curl http://192.168.49.2:31360/helloWorld/sayHello`}</span>
