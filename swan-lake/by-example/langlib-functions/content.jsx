...
<p>Langlib is a library defined by the language providing fundamental operations on built-in data types. Langlib functions can be called using the method-call syntax but these types are not objects.</p>


<p>There exists a <code>ballerina/lang.T</code> module for each built-in type <code>T</code> and they are automatically imported using the <code>T</code> prefix only if <code>T</code> corresponds to a keyword.</p>


<p>The <code>lang.value</code> module provides functions that work on values of more than one basic type.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/langlib-functions", "_blank");
      }}
