...
export function ListBindingPatternInMatchStatement({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        List binding patterns can be used in a match statement to bind parts of
        successfully matched list items to variables. The rest binding pattern (
        <code>...r</code>) can be used in the list binding pattern to bind the
        list items that are not explicitly bound in the mapping binding pattern.
      </p>
        ...
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
<<<<<<< HEAD
                "https://play.ballerina.io/?gist=8ad18425c433fb7f1b043275cb35c30f&file=list_binding_pattern_in_match_statement.bal",
=======
                "https://play.ballerina.io/?gist=117c25c098cca44ab5e80892e7da751a&file=list_binding_pattern_in_match_statement.bal",
>>>>>>> 4544b7b84e3fbafce0347071b7db377f1be8adda
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.7.0/examples/list-binding-pattern-in-match-statement",
                "_blank",
              );
            }}
      ...
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
        <li>
          <span>&#8226;&nbsp;</span>
          <span>
            <a href="/learn/by-example/rest-binding-pattern-in-list-binding-pattern/">
