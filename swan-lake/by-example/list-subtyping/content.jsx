...
export function ListSubtyping({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        An array with a length is a subtype of an array of same member type
        descriptor without a length. Two arrays with the same length or without
        a length is a subtype of the other if the member type descriptor is a
        subtype of the other. Tuple type <code>T</code> is a subtype of type{" "}
        <code>T1</code> if the set of values allowed in <code>T</code> is a sub
        set of values allowed in <code>T1</code>
      </p>
        ...
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
<<<<<<< HEAD
                "https://play.ballerina.io/?gist=4699fd44726c17aeb8db6c2b08e81caf&file=list_subtyping.bal",
=======
                "https://play.ballerina.io/?gist=dffa5c7f5c882b192acd388d5864272e&file=list_subtyping.bal",
>>>>>>> 4544b7b84e3fbafce0347071b7db377f1be8adda
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.7.0/examples/list-subtyping",
                "_blank",
              );
            }}
