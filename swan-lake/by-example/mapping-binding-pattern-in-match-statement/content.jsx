      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=6d0525bb7bcd779b32162359156b0cc6&file=mapping_binding_pattern_in_match_statement.bal",
                "_blank"
              );
            }}
            target="_blank"
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.4.1/examples/mapping-binding-pattern-in-match-statement",
                "_blank"
              );
            }}
