...
export function MappingBindingPatternInMatchStatement({codeSnippets}) {
...
const ref1 = createRef()
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>Mapping binding pattern in match statement</h1>


<p>Mapping binding patterns can be used in a match statement to bind parts of successfully matched mapping values to variables. The rest binding pattern (<code>...r</code>) can be used in the mapping binding pattern to bind mapping fields that are not explicitly bound in the binding pattern. This is particularly useful when working with open records.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/mapping-binding-pattern-in-match-statement", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run mapping_binding_pattern_in_match_statement.bal`}</span>
<span>{`3, 20`}</span>
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="/learn/by-example/match-statement/">Match Statement</a></span>
                        </li>
