...
export function MappingBindingPatternInMatchStatement({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        Mapping binding patterns can be used in a match statement to bind parts
        of successfully matched mapping values to variables. The rest binding
        pattern (<code>...r</code>) can be used in the mapping binding pattern
        to bind mapping fields that are not explicitly bound in the binding
        pattern. This is particularly useful when working with open records.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "vscode://wso2.ballerina/open-file?repoFileUrl=https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.8.2/examples/mapping-binding-pattern-in-match-statement/mapping_binding_pattern_in_match_statement.md",
                "_blank",
              );
            }}
            target="_blank"
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.8.2/examples/mapping-binding-pattern-in-match-statement",
                "_blank",
              );
            }}
      ...
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
        <li>
          <span>&#8226;&nbsp;</span>
          <span>
            <a href="/learn/by-example/mapping-binding-pattern/">
