...
const ref1 = createRef()
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>Match guard in <code>match</code> statement</h1>


<p>A match-guard is an expression that is used in a <code>match</code> clause to determine whether the clause should be executed. A <code>match</code> clause will only be executed if its match-guard evaluates to true.</p>


<p>A function call is only allowed with an expression in a match-guard when there is no possibility that it can mutate the value being matched.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/match-guard-in-match-statement", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run match_guard_in_match_statement.bal`}</span>
