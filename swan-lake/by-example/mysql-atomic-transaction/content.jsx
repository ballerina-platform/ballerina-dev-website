...
export default function MysqlAtomicTransaction() {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>MySQL client - Atomic transactions</h1>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.0/examples/mysql-atomic-transaction",
                "_blank"
              );
            }}
...
`}</span>
      ...
      <p>
        ...
        <code>useXADatasource</code> option should be enabled in the client as
        follows,
      </p>
