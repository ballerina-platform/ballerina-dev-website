...
export function MysqlBatchExecuteOperation({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        The <code>mysql:Client</code> allows executing a batch of DDL/DML
        statements with the use of <code>batchExecute</code> method. This method
        requires <code>sql:ParameterizedQuery[]</code>-typed SQL statements as
        arguments.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/mysql-batch-execute-operation",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run mysql_batch_execute_operation.bal`}</span>
            </code>
          </pre>
        </Col>
      </Row>
      ...
      >
        ...
        <Col sm={12}>
          <pre ref={ref2}>
            <code className="d-flex flex-column">
              <span>{`\$ curl http://localhost:8080/albums -d "[{\\"id\\": \\"B-121\\", \\"title\\": \\"Anti\\", \\"artist\\":\\"Rihanna\\", \\"price\\": 23.99}]" -H "Content-Type: application/json"`}</span>
            </code>
          </pre>
        </Col>
      </Row>
