...
<p>Named workers have a return type, which defaults to nil. A <code>return</code> statement in a named worker terminates the worker, not the function.</p>


<p>Similarly, when <code>check</code> is used and the expression evaluates to an <code>error</code>, the <code>error</code> value is returned terminating the worker. Waiting on a named worker will give its return value.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/named-worker-return-values", "_blank");
      }}
