...
export function NamedWorkerWithOnFailClause({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>Named worker with on fail clause</h1>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.7/examples/named-worker-with-on-fail-clause",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run named_worker_with_on_fail_clause.bal`}</span>
              <span>{`-1`}</span>
            </code>
          </pre>
        </Col>
