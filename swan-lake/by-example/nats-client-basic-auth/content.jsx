  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        ...
        secured with Basic Authentication. A secured <code>nats:Client</code>{" "}
        can be created by passing the URL of the NATS broker and providing the
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/nats-client-basic-auth",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run nats_client_basic_auth.bal`}</span>
            </code>
          </pre>
        </Col>
      </Row>
