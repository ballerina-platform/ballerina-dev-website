...
export function ObjectConstructor({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        In Ballerina, there are two ways to construct an object value with named
        methods and fields: using an object constructor or using the{" "}
        <code>new</code> expression with a <code>class</code> definition. The{" "}
        <code>init</code> method in an object constructor cannot have
        parameters.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "vscode://wso2.ballerina/open-file?repoFileUrl=https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.8.2/examples/object-constructor/object_constructor.md",
                "_blank",
              );
            }}
            target="_blank"
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.8.2/examples/object-constructor",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run object_constructor.bal`}</span>
              <span>{`Alice`}</span>
            </code>
          </pre>
        </Col>
