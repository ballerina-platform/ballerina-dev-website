...
export function ObjectTypes({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        An object type is a type definition without any implementation. It is
        similar to an interface as defined in the Java programming language.
        Object typing is structural and an object type looks like a pattern that
        ...
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
<<<<<<< HEAD
                "https://play.ballerina.io/?gist=327c9aaaab1fe3cccae80944f89cc71e&file=object_types.bal",
=======
                "https://play.ballerina.io/?gist=81c25a38abcc5841a02f8041581a2699&file=object_types.bal",
>>>>>>> 4544b7b84e3fbafce0347071b7db377f1be8adda
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.7.0/examples/object-types",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run object_types.bal`}</span>
              <span>{`true`}</span>
            </code>
          </pre>
        </Col>
