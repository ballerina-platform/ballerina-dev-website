...
<p>An object type is a type definition without any implementation. It is similar to an interface as defined in the Java programming language. Object typing is structural and an object type looks like a pattern that the object must match.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/object-types", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run object_types.bal`}</span>
<span>{`true`}</span>
</code></pre>
          </Col>
        </Row>
