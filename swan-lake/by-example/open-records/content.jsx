...
<p>A record type that uses either the <code>&#123;</code> and <code>&#125;</code> delimiters or the <code>&#123;|</code> and <code>|&#125;</code> delimiters with a rest descriptor is considered open. They allow fields other than those specified. The type of unspecified fields is <code>anydata</code>. Open records belong to <code>map&lt;anydata&gt;</code>. Quoted keys can be used to specify fields that are not mentioned in the record type.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/open-records", "_blank");
      }}
