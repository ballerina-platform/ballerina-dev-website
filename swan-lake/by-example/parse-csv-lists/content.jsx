...
export function ParseCsvLists({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>Parse CSV lists to custom types</h1>

      <p>
        Ballerina enables parsing CSV lists into various data structures,
        including custom <code>record</code> types and arrays. It facilitates
        parsing CSV lists into record types with specified fields, allowing for
        both reshaping of the data and maintaining its original structure.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/parse-csv-lists",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run parse_csv_lists.bal`}</span>
              <span>{`[{"empId":1,"empName":"John","department":"Engineering","salary":1000.0},{"empId":2,"empName":"Doe","department":"HR","salary":2000.0},{"empId":3,"empName":"Jane","department":"Finance","salary":3000.0}]`}</span>
