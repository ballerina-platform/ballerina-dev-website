...
export function PersistDelete({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>Persist write - Delete record</h1>
      ...
      <p>
        The generated client API provides a <code>delete</code> resource method
        to delete records from the data store.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/persist-delete",
                "_blank",
              );
            }}
...
`}</span>
      ...
      <p>
        Using the generated client API, you can delete records from the data
        store with the <code>delete</code> resource method.
      </p>
...
`}</span>
              ...
              <span>{`
`}</span>
              <span>{`Deleted employee record: {"id":"16c6553a-373c-4b29-b1c8-c282f444248c","firstName":"John","lastName":"Doe","birthDate":{"year":1987,"month":07,"day":23},"gender":"Male","hireDate":{"year":2020,"month":10,"day":10}}`}</span>
            </code>
          </pre>
        </Col>
      </Row>
