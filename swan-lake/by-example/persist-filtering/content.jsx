...
export function PersistFiltering({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>Persist read - Filter and sort</h1>
      ...
      <p>
        The generated client API provides <code>get</code> resource method to
        retrieve all records from the data store. As the <code>get</code>{" "}
        resource method returns a stream of records, we can use query
        expressions to do additional filter. For more information, see{" "}
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.10.2/examples/persist-filtering",
                "_blank",
              );
            }}
...
`}</span>
              ...
              <span>{`{"id":"9ae73215-207d-4e62-8596-5f2fd47ff7d5","firstName":"John","lastName":"Doe","birthDate":{"year":1987,"month":7,"day":23},"gender":"Male","age":33,"hireDate":{"year":2020,"month":10,"day":10}}`}</span>
              <span>{`Jane Doe`}</span>
              <span>{`John Doe`}</span>
              <span>{`Sam Curran`}</span>
              <span>{`{"id":"9ae73215-207d-4e62-8596-5f2fd47ff7d5","firstName":"John","lastName":"Doe","birthDate":{"year":1987,"month":7,"day":23},"gender":"Male","age":33,"hireDate":{"year":2020,"month":10,"day":10}}`}</span>
