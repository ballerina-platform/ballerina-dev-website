...
export function PersistGetByKey({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>Persist read - Get record by key</h1>
      ...
      <p>
        The generated client API provides <code>get by key</code> resource
        method to retrieve the record by the key from the data store.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/persist-get-by-key",
                "_blank",
              );
            }}
...
`}</span>
      ...
      <p>
        Using the generated client API, you can retrieve the record by key from
        the data store. The <code>get by key</code> resource method returns a
        record or error if no records are found for the given key.
      </p>
...
`}</span>
              ...
              <span>{`
`}</span>
              <span>{`{"id":"16c6553a-373c-4b29-b1c8-c282f444248c","firstName":"John","lastName":"Doe","birthDate":{"year":1987,"month":07,"day":23},"gender":"Male","hireDate":{"year":2020,"month":10,"day":10}}`}</span>
            </code>
          </pre>
        </Col>
      </Row>
