...
export function PersistRelationQueries({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>Persist read - Relation queries</h1>
      ...
      <p>
        The generated client API provides support to select fields in relational
        entities when retrieving the records/record from the <code>get</code>{" "}
        resource method from the data store.
      </p>
      ...
      <p>Execute the command below to initialize persistence in the project.</p>
...
`}</span>
      ...
      <p>
        Add <code>Employee</code>, <code>Department</code>,{" "}
        <code>Workspace</code>, and <code>Building</code> entities with
        relations in between in the <code>model.bal</code> file inside the{" "}
        <code>persist</code> directory.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/persist-relation-queries",
                "_blank",
              );
            }}
...
`}</span>
      ...
      <p>
        Using the generated client API, you can retrieve the record with
        relations from the data store with both <code>get</code> and{" "}
        <code>get by key</code> resource methods.
      </p>
...
`}</span>
              ...
              <span>{`
`}</span>
              <span>{`{"id":"1c09e131-364b-45f0-9f04-5e6a05bf8feb","firstName":"John","lastName":"Smith","workspace":{"id":"2c4696cf-a9a5-4b2e-be50-ccd3404394be","workspaceType":"Hot Desk"}}`}</span>
              <span>{`{"id":"4a5ae2c5-4df8-44b8-8da1-27585068071e","firstName":"Jane","lastName":"Doe","workspace":{"id":"b17f8735-f1b2-45fa-945a-2d9f5479af72","workspaceType":"Cubicle"}}`}</span>
              <span>{`{"id":"c53b2b5a-6763-43cf-ae61-de2fd5802eda","firstName":"John","lastName":"Doe","workspace":{"id":"3590c557-df63-4f90-bb60-23283655329b","workspaceType":"Cubicle"}}`}</span>
              <span>{`{"no":"D004","deptName":"Marketing","employees":[{"id":"4a5ae2c5-4df8-44b8-8da1-27585068071e","firstName":"Jane","lastName":"Doe"},{"id":"c53b2b5a-6763-43cf-ae61-de2fd5802eda","firstName":"John","lastName":"Doe"}]}`}</span>
              <span>{`{"no":"D005","deptName":"Sales","employees":[{"id":"1c09e131-364b-45f0-9f04-5e6a05bf8feb","firstName":"John","lastName":"Smith"}]}`}</span>
            </code>
          </pre>
        </Col>
      </Row>
      ...
      <Row className="mt-auto mb-5">
        <Col sm={6}>
          <Link
            ...
            href="/learn/by-example/persist-filtering/"
          >
