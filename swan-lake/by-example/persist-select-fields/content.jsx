...
export function PersistSelectFields({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>Persist read - Select fields</h1>
      ...
      <p>
        The generated client API provides support to select a subset of fields
        of the entity when retrieving the records/record from the{" "}
        <code>get</code> resource method from the data store.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/persist-select-fields",
                "_blank",
              );
            }}
...
`}</span>
      ...
      <p>
        ...
        selected fields from the data store with both <code>get</code> and{" "}
...
`}</span>
              ...
              <span>{`
`}</span>
              <span>{`{"id":"16c6553a-373c-4b29-b1c8-c282f444248c","firstName":"John","lastName":"Doe"}`}</span>
              <span>{`{"id":"16c6553a-373c-4b29-b1c8-c282f444248c","firstName":"John","lastName":"Doe"}`}</span>
            </code>
          </pre>
        </Col>
