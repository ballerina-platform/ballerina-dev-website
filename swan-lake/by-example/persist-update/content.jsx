...
export function PersistUpdate({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>Persist write - Update record</h1>
      ...
      <p>
        The generated client API provides a <code>put</code> resource method to
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/persist-update",
                "_blank",
              );
            }}
...
`}</span>
      ...
      <p>
        Using the generated client API, you can update the record in the data
        store with the <code>put</code> resource method.
      </p>
...
`}</span>
              ...
              <span>{`
`}</span>
              <span>{`Deleted employee record: {"id":"16c6553a-373c-4b29-b1c8-c282f444248c","firstName":"John","lastName":"Doe","birthDate":{"year":1987,"month":07,"day":23},"gender":"Male","hireDate":{"year":2014,"month":5,"day":1}}`}</span>
            </code>
          </pre>
        </Col>
      </Row>
