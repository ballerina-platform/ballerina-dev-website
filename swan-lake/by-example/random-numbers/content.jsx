...
export function RandomNumbers({codeSnippets}) {
...
<p>For more information on the underlying module, see the <a href="https://lib.ballerina.io/ballerina/random/latest/"><code>random</code> module</a>.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/random-numbers", "_blank");
      }}
