...
<p><code>isolated</code> functions can access <code>final</code> variables with <code>readonly</code> type without locking. It relies on the fact that immutability is deep. <code>isolated</code> for functions complements <code>readonly</code> for data.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/readonly-and-isolated", "_blank");
      }}
