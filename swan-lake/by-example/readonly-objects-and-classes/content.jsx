...
<p>An object is <code>readonly</code> if all of its fields are <code>final</code> and are of types that are subtypes of the <code>readonly</code> type. Object <code>T</code> can be declared as readonly with <code>readonly &amp; T</code>.</p>

<p>A class that belongs to the <code>readonly</code> type can be declared by prefixing the <code>readonly</code> keyword in the class declaration.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/readonly-objects-and-classes", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run readonly_objects_and_classes.bal`}</span>
<span>{`true`}</span>
<span>{`true`}</span>
</code></pre>
          </Col>
