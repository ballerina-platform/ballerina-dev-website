      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=fc6fbef0dca133d15aa17dd5ac96b920&file=schema.json",
                "_blank"
              );
            }}
            target="_blank"
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=5b4dd0595da61cc25189e7e2550255db&file=record_to_edi.bal",
                "_blank"
              );
            }}
            target="_blank"
