      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=7c8ce36462ee464ff38e06bb0108cfdd&file=schema.json",
                "_blank",
              );
            }}
            target="_blank"
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=31fc290110ecc8761d382de9b6ae659d&file=record_to_edi.bal",
                "_blank",
              );
            }}
            target="_blank"
