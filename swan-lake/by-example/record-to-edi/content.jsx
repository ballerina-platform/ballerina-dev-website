...
export function RecordToEdi({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>Record to EDI conversion</h1>

      <p>
        Same EDI schema and generated code used in EDI to record conversion
        example can be used to convert Ballerina records of type SimpleOrder to
        EDI.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=7a46b1c711cb34b421e5b53c9e511d0a&file=schema.json",
                "_blank",
              );
            }}
            target="_blank"
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.7.0/examples/record-to-edi",
                "_blank",
              );
            }}
      ...
      <p>
        Create a new Ballerina project named <code>record_to_edi</code> and
      ...
      <p>
        Write a Ballerina program by using generated methods and records to
        convert Ballerina records to EDI.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=40b67927d73335b08371d8eaeee62433&file=record_to_edi.bal",
                "_blank",
              );
            }}
            target="_blank"
        ...
        <Col sm={12}>
          <pre ref={ref3}>
            <code className="d-flex flex-column">
              ...
              <span>{`ITM*A680*15~`}</span>
              <span>{`ITM*A530*2~`}</span>
              <span>{`ITM*A500*4~`}</span>
            </code>
          </pre>
        </Col>
      </Row>
