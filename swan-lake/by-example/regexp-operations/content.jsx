      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=337d44bfcad00cc4fe1e9e7f7c6284cb&file=regexp_operations.bal",
                "_blank"
              );
            }}
            target="_blank"
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              ...
              <span>{`["bob@example.net","alice@example.com","charlie@example.org","david@example.xyz","emma@example.io"]`}</span>
              <span>{`["bob","alice","charlie","david","emma"]`}</span>
              <span>{`["example.net","example.com","example.org","example.xyz","example.io"]`}</span>
            </code>
          </pre>
        </Col>
      </Row>
