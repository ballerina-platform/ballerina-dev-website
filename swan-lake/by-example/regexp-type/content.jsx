...
export function RegexpType({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        <code>RegExp</code> is a built-in type in Ballerina that represents a
        regular expression. Regular expressions are commonly used for tasks such
        as validating input, searching and replacing text, and parsing data.
      </p>

      <p>
        The <code>RegExp</code> type is defined in the <code>lang.regexp</code>{" "}
        module, and can also be referenced using the type alias named the same
        in the <code>lang.string</code> module. The <code>RegExp</code> type
        conforms to a subset of the ECMAScript specification for regular
        expressions.
      </p>
        ...
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
<<<<<<< HEAD
                "https://play.ballerina.io/?gist=b018590e12e4474818e8226c0c7a2f5d&file=regexp_type.bal",
=======
                "https://play.ballerina.io/?gist=6357291e68e1565b25f6c6e735fcc432&file=regexp_type.bal",
>>>>>>> 4544b7b84e3fbafce0347071b7db377f1be8adda
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.7.0/examples/regexp-type",
                "_blank",
              );
            }}
      ...
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
        <li>
          <span>&#8226;&nbsp;</span>
          <span>
            <a href="https://ballerina.io/spec/lang/master/#section_10.1">
              Ballerina regular expression grammar
            </a>
          </span>
        </li>
      </ul>
