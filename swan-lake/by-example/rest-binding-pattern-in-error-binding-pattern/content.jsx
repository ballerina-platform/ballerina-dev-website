...
<p>You can use the rest binding pattern (<code>...r</code>) to bind the detail mappings that are not explicitly bound in the error binding pattern. The type of the rest binding will be a <code>map</code> holding the fields that have not been matched.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/rest-binding-pattern-in-error-binding-pattern", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run rest_binding_pattern_in_error_binding_pattern.bal`}</span>
