      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=e7338a57b1e26fc08ec3c260b16325f6&file=rest_binding_pattern_in_mapping_binding_pattern.bal",
                "_blank"
              );
            }}
            target="_blank"
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.4.1/examples/rest-binding-pattern-in-mapping-binding-pattern",
                "_blank"
              );
            }}
