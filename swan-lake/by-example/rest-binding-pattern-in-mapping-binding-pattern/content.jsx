      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=fa2c34c6173ffdfcb54d0d81bf5451c9&file=rest_binding_pattern_in_mapping_binding_pattern.bal",
                "_blank"
              );
            }}
            target="_blank"
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/rest-binding-pattern-in-mapping-binding-pattern",
                "_blank"
              );
            }}
