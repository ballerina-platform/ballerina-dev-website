...
export function SecurityJwtIssueValidate({codeSnippets}) {
...
<p>This example demonstrates how to issue a self-signed JWT and validate a JWT.</p>


<p>For more information on the underlying module, see the <a href="https://lib.ballerina.io/ballerina/jwt/latest/"><code>jwt</code> module</a>.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/security-jwt-issue-validate", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run security_jwt_issue_validate.bal`}</span>
