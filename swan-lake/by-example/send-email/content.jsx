...
<p>The <code>email:SmtpClient</code> connects to a given SMTP server to send emails. An <code>email:SmtpClient</code> is created by providing the hostname and required credentials.  Once connected, the <code>sendMessage</code> or the <code>send</code> methods are used to send emails. An <code>email:Message</code> record, which contains the required information about the email can be passed to the <code>sendMessage</code> method. If additional information is not required, the <code>send</code> method can be used only with mandatory parameters such as <code>to</code>, <code>from</code>, <code>subject</code>, and <code>body</code>.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/send-email", "_blank");
      }}
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="https://lib.ballerina.io/ballerina/email/latest#SmtpClient"><code>email:SmtpClient</code> client object - API documentation</a></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} class="relatedLinks">
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="https://lib.ballerina.io/ballerina/email/latest#Message"><code>email:Message</code> record - API documentation</a></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} class="relatedLinks">
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="https://ballerina.io/spec/email/#31-smtp-client">SMTP client - Specification</a></span>
                        </li>
