...
export function SensitiveDataLogging({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>Sensitive data logging</h1>

      <p>
        This example demonstrates how to mask sensitive data in log messages
        using the <code>@log:Sensitive</code> annotation. The Ballerina log
        module provides built-in capabilities to protect personally identifiable
        information (PII) and other sensitive data from being exposed in logs.
        By default, sensitive data masking is disabled and{" "}
        <strong>must be enabled</strong> in the configuration file.
      </p>
      ...
      <p>There are three masking strategies available:</p>

      <ul style={{ marginLeft: "0px" }}>
        <li>
          <span>1.</span>
          <span>
            <strong>Exclude strategy (default)</strong>: The sensitive field is
            completely excluded from log output.
          </span>
        </li>
      </ul>
      <ul style={{ marginLeft: "0px" }}>
      ...
      <ul style={{ marginLeft: "0px" }}>
        <li>
          <span>3.</span>
          <span>
            <strong>Custom function replacement</strong>: A custom function is
            used to mask the sensitive field.
          </span>
        </li>
      </ul>
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run sensitive_data_logging.bal`}</span>
              <span>{`
`}</span>
              <span>{`time=2025-10-07T15:32:20.226+05:30 level=INFO module="" message="User details" user={"id":"U001","creditCard":"****","ssn":"1****9","name":"John Doe"}`}</span>
            </code>
          </pre>
        </Col>
      </Row>
      ...
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
        <li>
          <span>&#8226;&nbsp;</span>
          <span>
            <a href="https://ballerina.io/spec/log/#5-sensitive-data-masking">
