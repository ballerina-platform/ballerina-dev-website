...
export default function SftpClient() {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.3/examples/sftp-client",
                "_blank"
              );
            }}
      ...
      <p>
        File content of the received file would get printed. The newly-added
        file will appear in the SFTP server.
      </p>
      ...
      <Row className="mt-auto mb-5">
        <Col sm={6}>
          <Link title="Listener" href="/learn/by-example/ftp-listener">
