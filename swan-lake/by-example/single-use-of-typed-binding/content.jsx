...
export function SingleUseOfTypedBinding({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        The single use of typed binding patterns is usually followed by an{" "}
        <code>=</code> operator.
      </p>
        ...
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
<<<<<<< HEAD
                "https://play.ballerina.io/?gist=1552128370385344083a7f41f51cfa41&file=single_use_of_typed_binding.bal",
=======
                "https://play.ballerina.io/?gist=3c7b4e79bd2102434e47426df625553e&file=single_use_of_typed_binding.bal",
>>>>>>> 4544b7b84e3fbafce0347071b7db377f1be8adda
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.7.0/examples/single-use-of-typed-binding",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run single_use_of_typed_binding.bal`}</span>
              <span>{`John 30`}</span>
              <span>{`John 30`}</span>
      ...
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
        <li>
          <span>&#8226;&nbsp;</span>
          <span>
            <a href="/learn/by-example/single-use-with-on-fail-clause/">
