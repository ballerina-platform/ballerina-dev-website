...
export function SingletonTypes({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        A singleton type is a type that contains exactly one value. A singleton
        type is described using a compile-time constant expression.
      </p>

      <p>
        When the simple constant expression is a variable reference to a
        structured value, the value will be an immutable value. Therefore, a
        mutable value will not belong to any singleton type.
      </p>

      <p>
        Unions of singletons enable the definition of more refined types,
        constraining the value space to include exactly the allowed values, and
        thereby, removing the need for explicit validation.
      </p>

      <p>
        The type of a constant is a singleton type and a constant can be used as
        a singleton type. Enumerations are shorthand for unions of
      </p>

      <p>
        string constants, and therefore, the members of an enumeration can also
        be used as singleton types.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/singleton-types",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run singleton_types.bal`}</span>
              <span>{`true`}</span>
              <span>{`false`}</span>
              <span>{`true`}</span>
              <span>{`false`}</span>
      ...
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
        <li>
          <span>&#8226;&nbsp;</span>
          <span>
            <a href="/learn/by-example/const-and-final/">Constants</a>
          </span>
        </li>
      </ul>
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
        <li>
          <span>&#8226;&nbsp;</span>
          <span>
            <a href="/learn/by-example/enumerations/">Enumerations</a>
          </span>
        </li>
      </ul>
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
        <li>
          <span>&#8226;&nbsp;</span>
          <span>
            <a href="/learn/by-example/immutability/">Immutability</a>
          </span>
        </li>
      </ul>
