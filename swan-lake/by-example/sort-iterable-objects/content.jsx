...
export function SortIterableObjects({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        The <code>order by</code> clause in the query expression can be used to
        sort the elements in a collection. Ordering works consistently with the{" "}
        <code>&lt;</code>, <code>&lt;=</code>, <code>&gt;</code>,{" "}
        <code>&gt;=</code> operators. Some comparisons involving <code>()</code>{" "}
        and float <code>NaN</code> are considered unordered. Therefore, if these
        unordered types are encountered in the query, they will be returned as
        the last elements of the ordered collection.
      </p>

      <p>
        The syntax to write an <code>order by</code> clause is{" "}
        <code>order by expression orderDirection</code>. The order direction can
        ...
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
<<<<<<< HEAD
                "https://play.ballerina.io/?gist=2d38c24b9253341acfa7ae14a2664010&file=sort_iterable_objects.bal",
=======
                "https://play.ballerina.io/?gist=a41c341b9762a9ba84c2bb77a827a294&file=sort_iterable_objects.bal",
>>>>>>> 4544b7b84e3fbafce0347071b7db377f1be8adda
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.7.0/examples/sort-iterable-objects",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run sort_iterable_objects.bal`}</span>
