...
export default function SpreadInBindingPatterns() {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>Rest binding pattern</h1>

      <p>
        You can use the rest binding pattern (<code>...r</code>) to bind the
        fields that are not explicitly bound in the binding pattern. This can be
        used in mapping, list, and error binding patterns.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=21360ea897d5669a3c86339c3880a531&file=spread_in_binding_patterns.bal",
                "_blank"
              );
            }}
            target="_blank"
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.1/examples/spread-in-binding-patterns",
                "_blank"
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run spread_in_binding_patterns.bal`}</span>
              <span>{`124`}</span>
              <span>{`2`}</span>
              <span>{`Peter`}</span>
              <span>{`Jackson`}</span>
