...
export function StopHandler({codeSnippets}) {
...
const ref2 = createRef()
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1><code>StopHandler</code></h1>


<p>The <code>StopHandler</code> registers a function that will be called during the graceful shutdown.</p>

<p>This example demonstrates how to register a function that will be executed at the end of the program.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/stop-handler", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`# Invoke the service using cURL to add a fruit item.`}</span>
