...
export function Strands({codeSnippets}) {
...
<p>By default, named workers are multitasked cooperatively, not preemptively. Each named worker has a &quot;strand&quot; (logical thread of control) and execution switches between strands only at specific &quot;yield&quot; points such as doing a wait or when a library function invokes a system call that would block.</p>


<p>This avoids the need for users to lock variables that are accessed from multiple named workers. An annotation can be used to make a strand run on a separate thread.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/strands", "_blank");
      }}
