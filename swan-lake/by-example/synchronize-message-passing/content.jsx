...
<p>Use <code>-&gt;&gt; W</code> to send a message synchronously to the <code>W</code> worker. These messages should be of the <code>anydata</code> type. Unlike asynchronous send, synchronous send will wait until the message is delivered. If the transmission fails with an <code>error</code> or a <code>panic</code>, then, the error will be propagated to the waiting strand. Otherwise, it will return <code>nil</code>.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/synchronize-message-passing", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run sync_send.bal`}</span>
