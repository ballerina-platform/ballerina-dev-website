...
<p>The table constructor expression looks like an array constructor. The <code>add</code> and <code>put</code> langlib functions can be used to update a table. The <code>put</code> method will update the table if there is an entry with a given key or add a new entry otherwise, while the <code>add</code> method will panic if there is an entry with the given key. The <code>foreach</code> statement will iterate over a table's rows in their order. Use <code>t[k]</code> to access a row using its key.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/table", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run table.bal`}</span>
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="/learn/by-example/maps/">Maps</a></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} class="relatedLinks">
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="/learn/by-example/structured-keys/">Structured keys</a></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} class="relatedLinks">
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="/learn/by-example/multiple-key-fields/">Multiple key fields</a></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} class="relatedLinks">
      ...
      <Link
        title="Table types"
        href="/learn/by-example/table-types"
      >
