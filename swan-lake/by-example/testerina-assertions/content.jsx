...
export const codeSnippetData = [`import ballerina/test;
...
export function TesterinaAssertions({codeSnippets}) {
...
<p>Testerina has in-built assertions that enable you to assert an outcome against an expected outcome. This example illustrates how to use different assertions.</p>


<p>For more information, see <a href="https://ballerina.io/learn/test-ballerina-code/write-tests/#use-assertions">Testing Ballerina Code</a> and the <a href="https://lib.ballerina.io/ballerina/test/latest/"><code>test</code> module</a>.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/testerina-assertions", "_blank");
      }}
