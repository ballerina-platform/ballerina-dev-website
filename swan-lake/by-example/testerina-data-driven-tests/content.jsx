...
<p>The Ballerina Test framework provides in-built support for data-driven tests. You can specify a function that returns a set of data values as a data-provider to a test function.</p>


<p>The test execution will iterate the same test function over the provided dataset.</p>


<p>For more information, see <a href="https://ballerina.io/learn/test-ballerina-code/define-data-driven-tests/">Testing Ballerina Code</a> and the <a href="https://lib.ballerina.io/ballerina/test/latest/"><code>test</code> module</a>.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/testerina-data-driven-tests", "_blank");
      }}
