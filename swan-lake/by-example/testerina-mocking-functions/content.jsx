...
export const codeSnippetData = [`// Calls the \`intAdd\` function and returns the result.
...
export function TesterinaMockingFunctions({codeSnippets}) {
...
<p>Mock functions allow you to hide the real function implementation and engage your own definition when running tests. This allows you to isolate your tests from the other modules and functions.</p>


<p>Function mocks can be stubbed with return values or with another user-defined function, which has the same signature as the original function.</p>


<p>For more information, see <a href="https://ballerina.io/learn/test-ballerina-code/mocking/#mock-functions">Testing Ballerina Code</a> and the <a href="https://lib.ballerina.io/ballerina/test/latest/"><code>test</code> module</a>.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/testerina-mocking-functions", "_blank");
      }}
