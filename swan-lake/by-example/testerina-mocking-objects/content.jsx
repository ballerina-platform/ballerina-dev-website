...
<p>Object mocking enables controlling the values of member variables and the behavior of the member functions of an object. Mocking of objects can be done in two ways.</p>
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>1.</span>
                            <span>Creating a test double - providing an equivalent mock object in place of the real</span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} >
                        <li>
                            <span>2.</span>
                            <span>Stubbing the member function or member variable - stubbing the behavior of functions and values of variables</span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} >
                        <li>
                            <span>3.</span>
                            <span>Creating a test double is suitable when a single mock function/object can be used throughout all tests whereas stubbing is ideal when defining different behaviors for different test cases is required.</span>
                        </li>
                    </ul>

<p>For more information, see <a href="https://ballerina.io/learn/test-ballerina-code/mocking/#mock-objects">Testing Ballerina Code</a> and the <a href="https://lib.ballerina.io/ballerina/test/latest/"><code>test</code> module</a>.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/testerina-mocking-objects", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal test bbe_mocking`}</span>
