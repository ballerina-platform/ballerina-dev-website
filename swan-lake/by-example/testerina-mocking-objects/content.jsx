...
export default function TesterinaMockingObjects() {
  ...
  return (
    <Container className="d-flex flex-column h-100">
      ...
      <ol>
        <li>
          Creating a test double - providing an equivalent mock object in place
          of the real&lt;br/&gt;
        </li>
      </ol>
      ...
      >
        ...
        <Col className="d-flex align-items-start pt-2" sm={2}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.1/examples/testerina-mocking-objects",
                "_blank"
              );
            }}
