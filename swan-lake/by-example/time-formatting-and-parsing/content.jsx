...
export function TimeFormattingAndParsing({codeSnippets}) {
...
<p>The Ballerina <code>time</code> library contains APIs to convert UTC and local time to different string representations (RFC 5322 and RFC 3339) vice versa.</p>


<p>For more information on the underlying module, see the <a href="https://lib.ballerina.io/ballerina/time/latest/"><code>time</code> module</a>.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/time-formatting-and-parsing", "_blank");
      }}
