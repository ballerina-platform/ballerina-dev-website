      ...
      <Row className="bbeCode px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
        ...
        <Col className="d-flex align-items-start pt-2" sm={2}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=63c60228020f4f6b1243b0d7744805de&file=time_formatting_and_parsing.bal",
                "_blank"
              );
            }}
            target="_blank"
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.0.3/time-formatting-and-parsing",
                "_blank"
              );
            }}
