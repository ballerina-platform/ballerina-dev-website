...
<p>The Ballerina <code>time</code> library contains an API to obtain the current time from the epoch <code>1970-01-01T00:00:00</code>.</p>


<p>For more information on the underlying module, see the <a href="https://lib.ballerina.io/ballerina/time/latest/"><code>time</code> module module</a>.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/time-utc", "_blank");
      }}
