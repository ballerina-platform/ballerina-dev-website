...
export function TimeZone({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        The Ballerina <code>time</code> library provides APIs for managing and
        converting time across different time zones. It supports loading system
        time zone, retrieving specific time zones based on the time zone ID, and
        enables seamless conversion between UTC and local times across different
        regions.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/time-zone",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run time_zone.bal`}</span>
              <span>{`Event time in UTC: [1643496480,0]`}</span>
              <span>{`Event time in system's local time: {"timeAbbrev":"Asia/Colombo","dayOfWeek":0,"year":2022,"month":1,"day":30,"hour":4,"minute":18,"second":0}`}</span>
              <span>{`Event time in Europe/London time zone: {"timeAbbrev":"Europe/London","dayOfWeek":6,"year":2022,"month":1,"day":29,"hour":22,"minute":48,"second":0}`}</span>
              <span>{`Event time in Asia/Tokyo time zone: {"timeAbbrev":"Asia/Tokyo","dayOfWeek":0,"year":2022,"month":1,"day":30,"hour":7,"minute":48,"second":0}`}</span>
            </code>
          </pre>
        </Col>
      </Row>
