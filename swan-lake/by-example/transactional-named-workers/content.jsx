...
<p>A named worker within a transactional function can be declared as <code>transactional</code>. This will start a new transaction branch for the named worker, as with a distributed transaction.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/transactional-named-workers", "_blank");
      }}
