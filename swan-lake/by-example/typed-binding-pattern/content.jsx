...
export function TypedBindingPattern({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        A typed binding pattern is a combination of a type and a binding
        pattern. It is used to create the variables occurring in the binding
        pattern. Use of <code>var</code> as the type means that the type is
        inferred. The two ways in which a typed binding pattern can be used are
        single use and iterative use.
      </p>
        ...
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
<<<<<<< HEAD
                "https://play.ballerina.io/?gist=5e298d8772690bc737bafc7e27f9a6df&file=typed_binding_pattern.bal",
=======
                "https://play.ballerina.io/?gist=852b63584353e9ab409ac34039acbef1&file=typed_binding_pattern.bal",
>>>>>>> 4544b7b84e3fbafce0347071b7db377f1be8adda
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.7.0/examples/typed-binding-pattern",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run typed_binding_pattern.bal`}</span>
              <span>{`John`}</span>
              <span>{`30`}</span>
      ...
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
        <li>
          <span>&#8226;&nbsp;</span>
          <span>
            <a href="/learn/by-example/iterative-use-of-typed-binding/">
