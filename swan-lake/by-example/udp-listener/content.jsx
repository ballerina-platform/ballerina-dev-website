...
service on new udp:Listener(8080) {
    ...
    remote method onDatagram(readonly & udp:Datagram datagram) returns udp:Datagram|udp:Error? {
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.3/examples/udp-listener",
                "_blank"
              );
            }}
