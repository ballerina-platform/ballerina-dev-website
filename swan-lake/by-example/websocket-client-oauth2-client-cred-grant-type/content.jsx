...
export default function WebsocketClientOauth2ClientCredGrantType() {
  ...
  return (
    <Container className="d-flex flex-column h-100">
      ...
      <p>
        passing the <code>websocket:OAuth2ClientCredentialsGrantConfig</code>{" "}
        for the <code>auth</code>
      </p>
      ...
      >
        ...
        <Col className="d-flex align-items-start pt-2" sm={2}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.1.1/examples/websocket-client-oauth2-client-cred-grant-type",
                "_blank"
              );
            }}
