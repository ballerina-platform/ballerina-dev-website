...
export default function WebsocketClientOauth2JwtBearerGrantType() {
  ...
  return (
    <Container className="d-flex flex-column h-100">
      ...
      <p>
        passing the <code>websocket:OAuth2JwtBearerGrantConfig</code> to the{" "}
        <code>auth</code>
      </p>
      ...
      <Row className="bbeCode px-2 py-0 rounded" style={{ marginLeft: "0px" }}>
        ...
        <Col className="d-flex align-items-start pt-2" sm={2}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.0.3/websocket-client-oauth2-jwt-bearer-grant-type",
                "_blank"
              );
            }}
