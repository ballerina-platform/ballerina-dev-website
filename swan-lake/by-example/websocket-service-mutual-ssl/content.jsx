...
service class WsService {
    *websocket:Service;
    remote method onMessage(websocket:Caller caller,
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.2.3/examples/websocket-service-mutual-ssl",
                "_blank"
              );
            }}
