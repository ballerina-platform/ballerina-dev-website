...
export const codeSnippetData = [`// The Ballerina WebSub Subscriber service, which could be used as a WebHook Listener for GitHub.
import ballerina/io;
...
<p>GitHub webhooks provide the capability to receive notifications based on the events in a GitHub repository. The Ballerina <code>websub</code> module can be used to define websub-compliant webhooks which are used to receive notifications from any websub-compliant <code>hub</code> implementation. Specify the GitHub pubsubhub API URL and the relevant event URL as the <code>target</code> parameter in <code>@websub:SubscriberServiceConfig</code> annotation. Start the <code>websub:SubscriberService</code> to receive event notifications.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/websub-webhook-sample", "_blank");
      }}
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="https://lib.ballerina.io/ballerina/websub/latest/"><code>websub</code> module - API documentation</a></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} class="relatedLinks">
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="https://ballerina.io/spec/websub/#22-subscriber-service">Websub subscriber service - Specification</a></span>
                        </li>
