...
export function WildcardBindingPattern({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        A wildcard binding pattern which is denoted by the <code>_</code>{" "}
        symbol, matches a value if the value belongs to type <code>any</code>.
        As long as the basic type of the value is not an <code>error</code>, it
        does not cause any assignment to be made to the variable. It is useful
        for ignoring values such as the return value of a function or values in
        a list.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "vscode://wso2.ballerina/open-file?repoFileUrl=https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.8.3/examples/wildcard-binding-pattern/wildcard_binding_pattern.md",
                "_blank",
              );
            }}
            target="_blank"
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.8.3/examples/wildcard-binding-pattern",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run wildcard_binding_pattern.bal`}</span>
            </code>
          </pre>
        </Col>
      </Row>
