...
export function WorkingDirectlyWithJson({ codeSnippets }) {
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://play.ballerina.io/?gist=16a005159b52f1278a907dc18f5b34ed&file=working_directly_with_json.bal",
                "_blank"
              );
            }}
            target="_blank"
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.3.1/examples/working-directly-with-json",
                "_blank"
              );
            }}
