...
export function XlsxTables({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>Work with Excel tables</h1>

      <p>
        The Ballerina <code>xlsx</code> library supports Excel tables, which are
        named, structured ranges within a sheet. A table can be created directly
        from an array of records and read back by table name.
      </p>
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run xlsx_tables.bal`}</span>
              <span>{`[{"item":"Laptop","quantity":2,"price":1250.0},{"item":"Monitor","quantity":5,"price":300.0}]`}</span>
            </code>
          </pre>
        </Col>
      </Row>
