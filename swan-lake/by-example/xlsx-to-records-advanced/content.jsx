...
export function XlsxToRecordsAdvanced({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>Parse Excel file to records - advanced</h1>

      <p>
        The Ballerina <code>xlsx</code> library supports customizing how sheet
        data binds to records. This example maps the <code>Employee Name</code>{" "}
        header with <code>@xlsx:Name</code>, matches <code>SALARY</code> to{" "}
        <code>salary</code> without case sensitivity, and reads only the first
        two data rows.
      </p>
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run xlsx_to_records_advanced.bal`}</span>
              <span>{`[{"name":"Alice","salary":4500.5},{"name":"Bob","salary":3800.0}]`}</span>
            </code>
          </pre>
        </Col>
      </Row>
