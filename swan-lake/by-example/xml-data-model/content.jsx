...
<p>An <code>xml</code> value is a sequence representing the parsed content of an XML element. An <code>xml</code> value has four kinds of items.</p>
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span>The element, processing instruction, and comment singletons correspond directly to the items in the XML information set</span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} >
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span>The text item corresponds to one or more character information items</span>
                        </li>
                    </ul>

<p>An XML document is an <code>xml</code> sequence with only one <code>element</code> and no <code>text</code>. An <code>element</code> item is mutable and consists of:</p>
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><code>name</code>: type <code>string</code></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} >
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><code>attributes</code>: type <code>map&lt;string&gt;</code></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} >
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><code>children</code>: type <code>xml</code></span>
                        </li>
                    </ul>
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span>it has no identity: <code>==</code> is the same as <code>===</code></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} >
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span>consecutive <code>text</code> items never occur in an <code>xml</code> value: they are always merged</span>
                        </li>
                    </ul>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/xml-data-model", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run xml_data_model.bal`}</span>
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="/learn/by-example/xml-operations/">XML operations</a></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} class="relatedLinks">
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="https://lib.ballerina.io/ballerina/lang.xml/latest/"><code>lang.xml</code> - Module documentation</a></span>
                        </li>
