...
export function XmlFromJsonConversion({codeSnippets}) {
...
<p>The <code>xmldata</code> library provides an API to perform conversions from JSON to XML.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/xml-from-json-conversion", "_blank");
      }}
