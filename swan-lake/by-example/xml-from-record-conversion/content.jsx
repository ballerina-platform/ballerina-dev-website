...
export function XmlFromRecordConversion({codeSnippets}) {
...
<p>The <code>xmldata</code> library provides APIs to perform the conversion from <code>Ballerina record/map&lt;anydata&gt;</code> to XML.</p>


<p>For more information on the underlying module, see the <a href="https://lib.ballerina.io/ballerina/xmldata/latest/"><code>xmldata</code> module</a>.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/xml-from-record-conversion", "_blank");
      }}
...
<Row className="bbeOutput mx-0 py-0 rounded " 
  ...
  <Col sm={12}>
    <pre ref={ref1}>
      <code className="d-flex flex-column"><span>{`\$ bal run xml_from_record_conversion.bal`}</span>
