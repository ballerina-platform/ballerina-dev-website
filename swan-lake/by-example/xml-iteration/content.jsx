...
export function XmlIteration({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        The <code>foreach</code> statement and <code>.forEach()</code> function
        available in the <code>lang.xml</code> library iterate the XML over each
        item.
      </p>
        ...
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
<<<<<<< HEAD
                "https://play.ballerina.io/?gist=1805612cf3f032bb145cba3ab6e1f69c&file=xml_iteration.bal",
=======
                "https://play.ballerina.io/?gist=143f0a99d70d9bf0a4e6bf2c097c4117&file=xml_iteration.bal",
>>>>>>> 4544b7b84e3fbafce0347071b7db377f1be8adda
          ...
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.7.0/examples/xml-iteration",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run xml_iteration.bal`}</span>
