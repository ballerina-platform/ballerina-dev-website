...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span>An <code>xml</code> value belongs to <code>xml:Element</code> if it consists of just an element item. Similarly for <code>xml:Comment</code> and <code>xml:ProcessingInstruction</code>.</span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} >
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span>An <code>xml</code> value belongs to <code>xml:Text</code> if it consists of a text item or is  empty.</span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} >
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span>An <code>xml</code> value belongs to the type <code>xml&lt;T&gt;</code> if each of its members belong to <code>T</code>.</span>
                        </li>
                    </ul>

<p>Functions in <code>lang.xml</code> use this to provide safe and convenient typing.</p>


<p>For example, <code>x.elements()</code> returns element items in <code>x</code> as type  <code>xml&lt;xml:Element&gt;</code> and <code>e.getName()</code> and <code>e.setNam ()</code> are defined when <code>e</code> has type <code>xml:Element</code>.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/xml-subtyping", "_blank");
      }}
...
<ul style={{ marginLeft: "0px" 
                        ...
                        <li>
                            <span>&#8226;&nbsp;</span>
                            <span><a href="/learn/by-example/xml-data-model/">XML data model</a></span>
                        </li>
                    </ul>
<ul style={{ marginLeft: "0px" 
                      }} class="relatedLinks">
...
<ul style={{ marginLeft: "0px" 
      ...
      <Link
        title="XML mutation"
        href="/learn/by-example/xml-mutation"
      >
