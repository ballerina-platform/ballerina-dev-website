...
<p><code>xml</code> values can be constructed using an XML template expression. Phase 2 processing for <code>xml</code> template tag parses strings using  the XML 1.0 Recommendation's grammar for content (what XML allows  between a start-tag and an end-tag).</p>


<p>Interpolated expressions can be in content (<code>xml</code> or <code>string</code> values) or in attribute values (<code>string</code> values).</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/xml-templates", "_blank");
      }}
