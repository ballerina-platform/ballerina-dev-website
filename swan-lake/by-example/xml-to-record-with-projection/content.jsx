...
export function XmlToRecordWithProjection({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>XML to record conversion with projection</h1>

      <p>
        The <code>data.xmldata</code> library provides multiple APIs to
        selectively convert elements and attributes from a XML source, which can
        be provided as a <code>string</code>, <code>byte array</code>,{" "}
        <code>byte block stream</code>, or <code>xml</code>, into a Ballerina
        record.
      </p>
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/xml-to-record-with-projection",
                "_blank",
              );
            }}
