...
export function XmlToRecord({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        The <code>data.xmldata</code> library provides multiple APIs to perform
        the conversion from XML source, which can be provided as a{" "}
        <code>string</code>, <code>byte array</code>,{" "}
      ...
      >
        <Col className="d-flex align-items-start" sm={12}>
          <button
            ...
            onClick={() => {
              window.open(
                "https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.12.10/examples/xml-to-record",
                "_blank",
              );
            }}
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run xml_to_record.bal`}</span>
              <span>{`{"id":10024,"title":"Clean Code","author":"Robert C. Martin"}`}</span>
              <span>{`{"id":10024,"title":"Clean Code","author":"Robert C. Martin"}`}</span>
              <span>{`{"id":10024,"title":"Clean Code","author":"Robert C. Martin"}`}</span>
              <span>{`{"id":10024,"title":"Clean Code","author":"Robert C. Martin"}`}</span>
            </code>
