...
<p>The <code>xslt</code> library provides an API to transform XML content to HTML using XSL transformation.</p>


<p>For more information on the underlying module, see the <a href="https://docs.central.ballerina.io/ballerina/xslt/latest/"><code>xslt</code> module</a>.</p>
...
<Row className="bbeCode mx-0 py-0 rounded 
  ...
  <Col className="d-flex align-items-start" sm={12}>
    ...
    <button
      ...
      onClick={() => {
        window.open("https://github.com/ballerina-platform/ballerina-distribution/tree/v2201.5.0/examples/xslt-transformation", "_blank");
      }}
