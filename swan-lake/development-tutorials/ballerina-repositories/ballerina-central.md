...
>**Tip:** As a precaution, use the [local repository](/learn/custom-repositories/local-repository/) first to test out the functionality of the package before publishing it to Ballerina Central.
