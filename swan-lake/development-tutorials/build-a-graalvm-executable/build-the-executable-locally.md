...
Packages that solely use Ballerina libraries and connectors or those that use platform Java libraries provided by the distribution are inferred to be compatible with GraalVM.
