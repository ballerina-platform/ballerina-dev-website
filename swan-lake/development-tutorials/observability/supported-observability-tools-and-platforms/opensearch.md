...
## Step 1 - Setup Ballerina application for observability
...
1. Create a new Ballerina project using the command below.
   ...
   Copy the sample [shop service](/learn/overview-of-ballerina-observability/#example-observe-a-ballerina-service) into the `main.bal` file in the `ballerina-app` project.
   
2. Open the `main.bal` file in the `ballerina-app` project and add the following imports.
