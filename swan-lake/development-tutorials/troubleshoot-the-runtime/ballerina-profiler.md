...
public function main() returns error? {
    int[] arr = check createRandomIntArray(20000);
...
![Profiler output](/learn/images/ballerina-profiler-output.png "Profiler output")
...
When you observe the flame graph generated by the Ballerina Profile for the above code, you can see the `bubbleSort` function has taken the most time(1477ms) to execute.
