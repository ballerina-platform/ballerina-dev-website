...
| `--org-name`        | Organization name to be used for the generated Ballerina package. For more information, see <a href="https://ballerina.io/learn/package-references/#the-org-field" target="_blank"> the <code>org</code> field</a>.                                                                                                                                                                                                         | Optional           |
| `--package-name`    | Package name to be used for the generated Ballerina package. If not specified, `health.fhir.templates.crd` will be used to construct the name of the package.                                                                                                                                                                                                         | Optional           |
