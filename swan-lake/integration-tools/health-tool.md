...
| `--package-name`    | Name of the Ballerina package to be generated. The package name can be explicitly set using this argument. Unless specified, the default name `health.fhir.templates.crd` will be used to construct the name of the package.                                                                                                                                                                                                         | Optional           |
