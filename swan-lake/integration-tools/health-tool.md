...
| `--org-name`        | The organization name is to be used for the generated Ballerina template. For more information, see <a href="https://ballerina.io/learn/package-references/#the-org-field" target="_blank"> the <code>org</code> field</a>.                                                                                                                                                                                                         | Optional           |
| `--package-name`    | The package name is to be used for the generated Ballerina template. If not specified, `health.fhir.templates.crd` will be used to construct the name of the package.                                                                                                                                                                                                         | Optional           |
| `--package-version` | The version of the Ballerina template is to be generated.                                                                                                                                                                                                                                                                                                                                                                                | Optional           |
