---
layout: ballerina-send-emails-from-a-service-left-nav-pages-swanlake
title: Send emails from a service
permalink: /learn/send-emails-from-a-service/
...
active: send-emails-from-a-service
