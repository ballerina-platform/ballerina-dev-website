...
```
> Note:the external API returns additional fields such as ‘capital’ , ‘language’ and ‘currency’.
>these fields are safely ignored because the ‘ country ‘ record defines only the fields required by this example.
