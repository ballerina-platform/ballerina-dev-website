...
| `--with-optional-types-param`                         | Generate optional(i.e. nilable) types for function parameter types, to pass java null values to the underneath Java API.                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | Optional  |
