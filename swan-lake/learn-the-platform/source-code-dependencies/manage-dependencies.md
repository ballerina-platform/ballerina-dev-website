...
>**Note:** Automatic updates for minor and major versions are not supported by the compiler. However, the minimum dependency version can be specified in the `Ballerina.toml` file.
