...
1. Execute the `ballerina new hello_world_sample` command to create a new project named `hello_world_sample`.

2. Navigate to the directory of the project and execute the `ballerina add hello` command to create a module named `hello` inside the project.

3. Replace the content of the `/hello_world_sample/hello/src/main.bal` file with the content below.
...
4. Create a file named `Ballerina.cloud` in the project directory and add the content below.
...
Execute the `ballerina build -a` command to build the Ballerina project and you view the output below.
...
1. Execute the `ballerina new scaling_sample` command to create a new project named `hello_world_sample`.

2. Navigate to the directory of the project and execute the `ballerina add scaling` command to create a module named `scaling` inside the project.

3. Replace the content of the `/scaling_sample/hello/src/main.bal` file with the content below.
...
>**Note:** The code of this sample is identical to the [Hello World Sample](#hello-world-sample). The only difference is the contents of the `Ballerina.cloud` file. Therefore, the behavior of the application in this sample is also identical to the [Hello World Sample](#hello-world-sample). The difference is the generated artifacts of Docker and Kubernetes. Let’s observe the artifacts below generated by building the project.
