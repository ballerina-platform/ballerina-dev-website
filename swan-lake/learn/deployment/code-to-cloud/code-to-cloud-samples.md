...
1. Execute the `ballerina new hello_world_sample` command to create a new package named `hello_world_sample`.

2. Navigate to the directory of the package and execute the `ballerina add hello` command to create a module named `hello` inside the package.
...
1. Execute the `ballerina new scaling_sample` command to create a new package named `hello_world_sample`.

2. Navigate to the directory of the package and execute the `ballerina add scaling` command to create a module named `scaling` inside the package.
