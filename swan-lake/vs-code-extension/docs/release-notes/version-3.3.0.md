...
![data-mapper](..//learn/images/vs-code-extension/release-notes/v-3.3.0/data-mapper.gif){.cInlineImage-full}
...
## GraphQL Tryit
![graphql-tryit](..//learn/images/vs-code-extension/release-notes/v-3.3.0/graphql-tryit.gif){.cInlineImage-full}
...
## Record Editor
![record-editor](..//learn/images/vs-code-extension/release-notes/v-3.3.0/record-editor.gif){.cInlineImage-full}
...
![design-view](..//learn/images/vs-code-extension/release-notes/v-3.3.0/design-view.gif){.cInlineImage-full}
