...
cp -r ./out/learn/native-executable-support/* ./out/learn
...
rm -rf ./out/learn/native-executable-support/ ./out/learn/ballerina-central/ ./out/learn/ballerina-tooling/ ./out/learn/configure-observe/ ./out/learn/java-interoperability/ ./out/learn/test-document-the-code/ ./out/learn/source-code-dependencies/ ./out/learn/ballerina-persist/
...
sed -i 's/native-executable-support\///g' ./out/sitemap.xml
