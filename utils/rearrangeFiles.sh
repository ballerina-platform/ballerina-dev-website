...
cp -r ./out/learn/configure-ballerina-programs/* ./out/learn
cp -r ./out/learn/java-interoperability/* ./out/learn
cp -r ./out/learn/observe-ballerina-programs/* ./out/learn
...
rm -rf ./out/learn/build-a-graalvm-executable ./out/learn/ballerina-central/ ./out/learn/configure-ballerina-programs/ ./out/learn/java-interoperability/ ./out/learn/test-document-the-code/ ./out/learn/source-code-dependencies/ ./out/learn/ballerina-persist/ ./out/learn/build-and-run/ ./out/learn/observe-ballerina-programs/ ./out/learn/featured-scenarios/ ./out/learn/learn-the-language/*
...
sed -i '' 's/observe-ballerina-programs\///g' ./out/sitemap.xml
sed -i '' 's/configure-ballerina-programs\///g' ./out/sitemap.xml
