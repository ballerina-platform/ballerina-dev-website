...
* When formatting resource functions and function definitions, block indent each element and
  follow the [function formatting guidelines](/v1-1/learn/style-guide/definitions#function-definition).
...
* For function definitions in the object definition, follow the [function formatting guidelines](/v1-1/learn/style-guide/definitions#function-definition).
