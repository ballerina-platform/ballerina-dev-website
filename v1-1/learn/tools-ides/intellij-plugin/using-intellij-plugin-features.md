...
1. Click the green color icon located near the main function.
    ...
    ![Click the Run Application icon](/v1-1/learn/images/run-application-icon.png)

2. Click the corresponding **Run <FILE_NAME>** command.

    ![Click the Run command](/v1-1/learn/images/select-run-command.png)

This executes the main function of the Ballerina file and displays the output in the **Run** window.

![Output of running the main function](/v1-1/learn/images/output-of-main-function.png)
...
![Output of running a service](/v1-1/learn/images/output-of-ballerina-service.png)
...
![Debug Ballerina programs](/v1-1/learn/images/debug-ballerina-intellij.gif)
...
![HTTP circuit breaker sequence diagram](/v1-1/learn/images/circuit-breaker-sequence-diagram.gif)
...
![Import modules on the fly](/v1-1/learn/images/import-modules-on-the-fly.gif)
...
![Import unambiguous modules](/v1-1/learn/images/import-unambiguous-modules.gif)

## Formatting Ballerina codes

You can reformat the Ballerina codes by pressing the **Ctrl+Alt+L** keys.

![Formatting Ballerina codes](/v1-1/learn/images/format-code.gif)
...
![Viewing documentation](/v1-1/learn/images/view-documentation.gif)
...
![Adding annotation fields via suggestions](/v1-1/learn/images/annotation-field-suggestion.gif)
...
![Using file templates](/v1-1/learn/images/file-templates.gif)
...
![Using code snippet templates](/v1-1/learn/images/code-snippet-templates.gif)

## Checking spellings

The spell-checker is enabled for all identifiers. You can rename all of the definitions and references as well.

![Checking spellings](/v1-1/learn/images/check-spellings.gif)
...
![Analyzing semantics](/v1-1/learn/images/analyzing-semantics.gif)
